...
// flCreate = (FCF_STANDARD) & ~FCF_TASKLIST;
        ...
        window->frame = WinCreateStdWindow(HWND_DESKTOP,
...
// erridErrorCode = WinGetLastError(hab);
//
//  fcd.flCreateFlags |= FCF_SYSMENU;
//
// window->win = WinCreateWindow(HWND_DESKTOP, "GLUT", "GLUT",
//           flStyle,x, y, width, height,  parent ? parent->win : NULLHANDLE,
//          HWND_TOP, window->num, &fcd, NULL);
