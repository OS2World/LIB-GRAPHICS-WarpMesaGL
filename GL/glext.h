...
typedef void (APIENTRY FNGLBLENDFUNCSEPARATEPROC) (GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
typedef FNGLBLENDFUNCSEPARATEPROC *PFNGLBLENDFUNCSEPARATEPROC;
typedef void (APIENTRY FNGLFOGCOORDFPROC) (GLfloat coord);
typedef FNGLFOGCOORDFPROC *PFNGLFOGCOORDFPROC;
typedef void (APIENTRY FNGLFOGCOORDFVPROC) (const GLfloat *coord);
typedef FNGLFOGCOORDFVPROC *PFNGLFOGCOORDFVPROC;
typedef void (APIENTRY FNGLFOGCOORDDPROC) (GLdouble coord);
typedef FNGLFOGCOORDDPROC *PFNGLFOGCOORDDPROC;
typedef void (APIENTRY FNGLFOGCOORDDVPROC) (const GLdouble *coord);
typedef FNGLFOGCOORDDVPROC *PFNGLFOGCOORDDVPROC;
typedef void (APIENTRY FNGLFOGCOORDPOINTERPROC) (GLenum type, GLsizei stride, const GLvoid *pointer);
typedef FNGLFOGCOORDPOINTERPROC *PFNGLFOGCOORDPOINTERPROC;
typedef void (APIENTRY FNGLMULTIDRAWARRAYSPROC) (GLenum mode, GLint *first, GLsizei *count, GLsizei primcount);
typedef FNGLMULTIDRAWARRAYSPROC *PFNGLMULTIDRAWARRAYSPROC;
typedef void (APIENTRY FNGLMULTIDRAWELEMENTSPROC) (GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount);
typedef FNGLMULTIDRAWELEMENTSPROC *PFNGLMULTIDRAWELEMENTSPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERFPROC) (GLenum pname, GLfloat param);
typedef FNGLPOINTPARAMETERFPROC *PFNGLPOINTPARAMETERFPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERFVPROC) (GLenum pname, const GLfloat *params);
typedef FNGLPOINTPARAMETERFVPROC *PFNGLPOINTPARAMETERFVPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERIPROC) (GLenum pname, GLint param);
typedef FNGLPOINTPARAMETERIPROC *PFNGLPOINTPARAMETERIPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERIVPROC) (GLenum pname, const GLint *params);
typedef FNGLPOINTPARAMETERIVPROC *PFNGLPOINTPARAMETERIVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3BPROC) (GLbyte red, GLbyte green, GLbyte blue);
typedef FNGLSECONDARYCOLOR3BPROC *PFNGLSECONDARYCOLOR3BPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3BVPROC) (const GLbyte *v);
typedef FNGLSECONDARYCOLOR3BVPROC *PFNGLSECONDARYCOLOR3BVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3DPROC) (GLdouble red, GLdouble green, GLdouble blue);
typedef FNGLSECONDARYCOLOR3DPROC *PFNGLSECONDARYCOLOR3DPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3DVPROC) (const GLdouble *v);
typedef FNGLSECONDARYCOLOR3DVPROC *PFNGLSECONDARYCOLOR3DVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3FPROC) (GLfloat red, GLfloat green, GLfloat blue);
typedef FNGLSECONDARYCOLOR3FPROC *PFNGLSECONDARYCOLOR3FPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3FVPROC) (const GLfloat *v);
typedef FNGLSECONDARYCOLOR3FVPROC *PFNGLSECONDARYCOLOR3FVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3IPROC) (GLint red, GLint green, GLint blue);
typedef FNGLSECONDARYCOLOR3IPROC *PFNGLSECONDARYCOLOR3IPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3IVPROC) (const GLint *v);
typedef FNGLSECONDARYCOLOR3IVPROC *PFNGLSECONDARYCOLOR3IVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3SPROC) (GLshort red, GLshort green, GLshort blue);
typedef FNGLSECONDARYCOLOR3SPROC *PFNGLSECONDARYCOLOR3SPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3SVPROC) (const GLshort *v);
typedef FNGLSECONDARYCOLOR3SVPROC *PFNGLSECONDARYCOLOR3SVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UBPROC) (GLubyte red, GLubyte green, GLubyte blue);
typedef FNGLSECONDARYCOLOR3UBPROC *PFNGLSECONDARYCOLOR3UBPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UBVPROC) (const GLubyte *v);
typedef FNGLSECONDARYCOLOR3UBVPROC *PFNGLSECONDARYCOLOR3UBVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UIPROC) (GLuint red, GLuint green, GLuint blue);
typedef FNGLSECONDARYCOLOR3UIPROC *PFNGLSECONDARYCOLOR3UIPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UIVPROC) (const GLuint *v);
typedef FNGLSECONDARYCOLOR3UIVPROC *PFNGLSECONDARYCOLOR3UIVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3USPROC) (GLushort red, GLushort green, GLushort blue);
typedef FNGLSECONDARYCOLOR3USPROC *PFNGLSECONDARYCOLOR3USPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3USVPROC) (const GLushort *v);
typedef FNGLSECONDARYCOLOR3USVPROC *PFNGLSECONDARYCOLOR3USVPROC;
typedef void (APIENTRY FNGLSECONDARYCOLORPOINTERPROC) (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef FNGLSECONDARYCOLORPOINTERPROC *PFNGLSECONDARYCOLORPOINTERPROC;
typedef void (APIENTRY FNGLWINDOWPOS2DPROC) (GLdouble x, GLdouble y);
typedef FNGLWINDOWPOS2DPROC *PFNGLWINDOWPOS2DPROC;
typedef void (APIENTRY FNGLWINDOWPOS2DVPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS2DVPROC *PFNGLWINDOWPOS2DVPROC;
typedef void (APIENTRY FNGLWINDOWPOS2FPROC) (GLfloat x, GLfloat y);
typedef FNGLWINDOWPOS2FPROC *PFNGLWINDOWPOS2FPROC;
typedef void (APIENTRY FNGLWINDOWPOS2FVPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS2FVPROC *PFNGLWINDOWPOS2FVPROC;
typedef void (APIENTRY FNGLWINDOWPOS2IPROC) (GLint x, GLint y);
typedef FNGLWINDOWPOS2IPROC *PFNGLWINDOWPOS2IPROC;
typedef void (APIENTRY FNGLWINDOWPOS2IVPROC) (const GLint *v);
typedef FNGLWINDOWPOS2IVPROC *PFNGLWINDOWPOS2IVPROC;
typedef void (APIENTRY FNGLWINDOWPOS2SPROC) (GLshort x, GLshort y);
typedef FNGLWINDOWPOS2SPROC *PFNGLWINDOWPOS2SPROC;
typedef void (APIENTRY FNGLWINDOWPOS2SVPROC) (const GLshort *v);
typedef FNGLWINDOWPOS2SVPROC *PFNGLWINDOWPOS2SVPROC;
typedef void (APIENTRY FNGLWINDOWPOS3DPROC) (GLdouble x, GLdouble y, GLdouble z);
typedef FNGLWINDOWPOS3DPROC *PFNGLWINDOWPOS3DPROC;
typedef void (APIENTRY FNGLWINDOWPOS3DVPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS3DVPROC *PFNGLWINDOWPOS3DVPROC;
typedef void (APIENTRY FNGLWINDOWPOS3FPROC) (GLfloat x, GLfloat y, GLfloat z);
typedef FNGLWINDOWPOS3FPROC *PFNGLWINDOWPOS3FPROC;
typedef void (APIENTRY FNGLWINDOWPOS3FVPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS3FVPROC *PFNGLWINDOWPOS3FVPROC;
typedef void (APIENTRY FNGLWINDOWPOS3IPROC) (GLint x, GLint y, GLint z);
typedef FNGLWINDOWPOS3IPROC *PFNGLWINDOWPOS3IPROC;
typedef void (APIENTRY FNGLWINDOWPOS3IVPROC) (const GLint *v);
typedef FNGLWINDOWPOS3IVPROC *PFNGLWINDOWPOS3IVPROC;
typedef void (APIENTRY FNGLWINDOWPOS3SPROC) (GLshort x, GLshort y, GLshort z);
typedef FNGLWINDOWPOS3SPROC *PFNGLWINDOWPOS3SPROC;
typedef void (APIENTRY FNGLWINDOWPOS3SVPROC) (const GLshort *v);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLLOADTRANSPOSEMATRIXFARBPROC) (const GLfloat *m);
typedef FNGLLOADTRANSPOSEMATRIXFARBPROC *PFNGLLOADTRANSPOSEMATRIXFARBPROC;
typedef void (APIENTRY FNGLLOADTRANSPOSEMATRIXDARBPROC) (const GLdouble *m);
typedef FNGLLOADTRANSPOSEMATRIXDARBPROC *PFNGLLOADTRANSPOSEMATRIXDARBPROC;
typedef void (APIENTRY FNGLMULTTRANSPOSEMATRIXFARBPROC) (const GLfloat *m);
typedef FNGLMULTTRANSPOSEMATRIXFARBPROC *PFNGLMULTTRANSPOSEMATRIXFARBPROC;
typedef void (APIENTRY FNGLMULTTRANSPOSEMATRIXDARBPROC) (const GLdouble *m);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLSAMPLECOVERAGEARBPROC) (GLclampf value, GLboolean invert);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOMPRESSEDTEXIMAGE3DARBPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLsizei imageSize, const GLvoid *data);
typedef FNGLCOMPRESSEDTEXIMAGE3DARBPROC *PFNGLCOMPRESSEDTEXIMAGE3DARBPROC;
typedef void (APIENTRY FNGLCOMPRESSEDTEXIMAGE2DARBPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLint border, GLsizei imageSize, const GLvoid *data);
typedef FNGLCOMPRESSEDTEXIMAGE2DARBPROC *PFNGLCOMPRESSEDTEXIMAGE2DARBPROC;
typedef void (APIENTRY FNGLCOMPRESSEDTEXIMAGE1DARBPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLint border, GLsizei imageSize, const GLvoid *data);
typedef FNGLCOMPRESSEDTEXIMAGE1DARBPROC *PFNGLCOMPRESSEDTEXIMAGE1DARBPROC;
typedef void (APIENTRY FNGLCOMPRESSEDTEXSUBIMAGE3DARBPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLsizei imageSize, const GLvoid *data);
typedef FNGLCOMPRESSEDTEXSUBIMAGE3DARBPROC *PFNGLCOMPRESSEDTEXSUBIMAGE3DARBPROC;
typedef void (APIENTRY FNGLCOMPRESSEDTEXSUBIMAGE2DARBPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLsizei imageSize, const GLvoid *data);
typedef FNGLCOMPRESSEDTEXSUBIMAGE2DARBPROC *PFNGLCOMPRESSEDTEXSUBIMAGE2DARBPROC;
typedef void (APIENTRY FNGLCOMPRESSEDTEXSUBIMAGE1DARBPROC) (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLsizei imageSize, const GLvoid *data);
typedef FNGLCOMPRESSEDTEXSUBIMAGE1DARBPROC *PFNGLCOMPRESSEDTEXSUBIMAGE1DARBPROC;
typedef void (APIENTRY FNGLGETCOMPRESSEDTEXIMAGEARBPROC) (GLenum target, GLint level, void *img);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPOINTPARAMETERFARBPROC) (GLenum pname, GLfloat param);
typedef FNGLPOINTPARAMETERFARBPROC *PFNGLPOINTPARAMETERFARBPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERFVARBPROC) (GLenum pname, const GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLWEIGHTBVARBPROC) (GLint size, const GLbyte *weights);
typedef FNGLWEIGHTBVARBPROC *PFNGLWEIGHTBVARBPROC;
typedef void (APIENTRY FNGLWEIGHTSVARBPROC) (GLint size, const GLshort *weights);
typedef FNGLWEIGHTSVARBPROC *PFNGLWEIGHTSVARBPROC;
typedef void (APIENTRY FNGLWEIGHTIVARBPROC) (GLint size, const GLint *weights);
typedef FNGLWEIGHTIVARBPROC *PFNGLWEIGHTIVARBPROC;
typedef void (APIENTRY FNGLWEIGHTFVARBPROC) (GLint size, const GLfloat *weights);
typedef FNGLWEIGHTFVARBPROC *PFNGLWEIGHTFVARBPROC;
typedef void (APIENTRY FNGLWEIGHTDVARBPROC) (GLint size, const GLdouble *weights);
typedef FNGLWEIGHTDVARBPROC *PFNGLWEIGHTDVARBPROC;
typedef void (APIENTRY FNGLWEIGHTUBVARBPROC) (GLint size, const GLubyte *weights);
typedef FNGLWEIGHTUBVARBPROC *PFNGLWEIGHTUBVARBPROC;
typedef void (APIENTRY FNGLWEIGHTUSVARBPROC) (GLint size, const GLushort *weights);
typedef FNGLWEIGHTUSVARBPROC *PFNGLWEIGHTUSVARBPROC;
typedef void (APIENTRY FNGLWEIGHTUIVARBPROC) (GLint size, const GLuint *weights);
typedef FNGLWEIGHTUIVARBPROC *PFNGLWEIGHTUIVARBPROC;
typedef void (APIENTRY FNGLWEIGHTPOINTERARBPROC) (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef FNGLWEIGHTPOINTERARBPROC *PFNGLWEIGHTPOINTERARBPROC;
typedef void (APIENTRY FNGLVERTEXBLENDARBPROC) (GLint count);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCURRENTPALETTEMATRIXARBPROC) (GLint index);
typedef FNGLCURRENTPALETTEMATRIXARBPROC *PFNGLCURRENTPALETTEMATRIXARBPROC;
typedef void (APIENTRY FNGLMATRIXINDEXUBVARBPROC) (GLint size, const GLubyte *indices);
typedef FNGLMATRIXINDEXUBVARBPROC *PFNGLMATRIXINDEXUBVARBPROC;
typedef void (APIENTRY FNGLMATRIXINDEXUSVARBPROC) (GLint size, const GLushort *indices);
typedef FNGLMATRIXINDEXUSVARBPROC *PFNGLMATRIXINDEXUSVARBPROC;
typedef void (APIENTRY FNGLMATRIXINDEXUIVARBPROC) (GLint size, const GLuint *indices);
typedef FNGLMATRIXINDEXUIVARBPROC *PFNGLMATRIXINDEXUIVARBPROC;
typedef void (APIENTRY FNGLMATRIXINDEXPOINTERARBPROC) (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLWINDOWPOS2DARBPROC) (GLdouble x, GLdouble y);
typedef FNGLWINDOWPOS2DARBPROC *PFNGLWINDOWPOS2DARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2DVARBPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS2DVARBPROC *PFNGLWINDOWPOS2DVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2FARBPROC) (GLfloat x, GLfloat y);
typedef FNGLWINDOWPOS2FARBPROC *PFNGLWINDOWPOS2FARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2FVARBPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS2FVARBPROC *PFNGLWINDOWPOS2FVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2IARBPROC) (GLint x, GLint y);
typedef FNGLWINDOWPOS2IARBPROC *PFNGLWINDOWPOS2IARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2IVARBPROC) (const GLint *v);
typedef FNGLWINDOWPOS2IVARBPROC *PFNGLWINDOWPOS2IVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2SARBPROC) (GLshort x, GLshort y);
typedef FNGLWINDOWPOS2SARBPROC *PFNGLWINDOWPOS2SARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS2SVARBPROC) (const GLshort *v);
typedef FNGLWINDOWPOS2SVARBPROC *PFNGLWINDOWPOS2SVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3DARBPROC) (GLdouble x, GLdouble y, GLdouble z);
typedef FNGLWINDOWPOS3DARBPROC *PFNGLWINDOWPOS3DARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3DVARBPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS3DVARBPROC *PFNGLWINDOWPOS3DVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3FARBPROC) (GLfloat x, GLfloat y, GLfloat z);
typedef FNGLWINDOWPOS3FARBPROC *PFNGLWINDOWPOS3FARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3FVARBPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS3FVARBPROC *PFNGLWINDOWPOS3FVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3IARBPROC) (GLint x, GLint y, GLint z);
typedef FNGLWINDOWPOS3IARBPROC *PFNGLWINDOWPOS3IARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3IVARBPROC) (const GLint *v);
typedef FNGLWINDOWPOS3IVARBPROC *PFNGLWINDOWPOS3IVARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3SARBPROC) (GLshort x, GLshort y, GLshort z);
typedef FNGLWINDOWPOS3SARBPROC *PFNGLWINDOWPOS3SARBPROC;
typedef void (APIENTRY FNGLWINDOWPOS3SVARBPROC) (const GLshort *v);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLVERTEXATTRIB1DARBPROC) (GLuint index, GLdouble x);
typedef FNGLVERTEXATTRIB1DARBPROC *PFNGLVERTEXATTRIB1DARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1DVARBPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB1DVARBPROC *PFNGLVERTEXATTRIB1DVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1FARBPROC) (GLuint index, GLfloat x);
typedef FNGLVERTEXATTRIB1FARBPROC *PFNGLVERTEXATTRIB1FARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1FVARBPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB1FVARBPROC *PFNGLVERTEXATTRIB1FVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1SARBPROC) (GLuint index, GLshort x);
typedef FNGLVERTEXATTRIB1SARBPROC *PFNGLVERTEXATTRIB1SARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1SVARBPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB1SVARBPROC *PFNGLVERTEXATTRIB1SVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2DARBPROC) (GLuint index, GLdouble x, GLdouble y);
typedef FNGLVERTEXATTRIB2DARBPROC *PFNGLVERTEXATTRIB2DARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2DVARBPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB2DVARBPROC *PFNGLVERTEXATTRIB2DVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2FARBPROC) (GLuint index, GLfloat x, GLfloat y);
typedef FNGLVERTEXATTRIB2FARBPROC *PFNGLVERTEXATTRIB2FARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2FVARBPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB2FVARBPROC *PFNGLVERTEXATTRIB2FVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2SARBPROC) (GLuint index, GLshort x, GLshort y);
typedef FNGLVERTEXATTRIB2SARBPROC *PFNGLVERTEXATTRIB2SARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2SVARBPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB2SVARBPROC *PFNGLVERTEXATTRIB2SVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3DARBPROC) (GLuint index, GLdouble x, GLdouble y, GLdouble z);
typedef FNGLVERTEXATTRIB3DARBPROC *PFNGLVERTEXATTRIB3DARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3DVARBPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB3DVARBPROC *PFNGLVERTEXATTRIB3DVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3FARBPROC) (GLuint index, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLVERTEXATTRIB3FARBPROC *PFNGLVERTEXATTRIB3FARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3FVARBPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB3FVARBPROC *PFNGLVERTEXATTRIB3FVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3SARBPROC) (GLuint index, GLshort x, GLshort y, GLshort z);
typedef FNGLVERTEXATTRIB3SARBPROC *PFNGLVERTEXATTRIB3SARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3SVARBPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB3SVARBPROC *PFNGLVERTEXATTRIB3SVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NBVARBPROC) (GLuint index, const GLbyte *v);
typedef FNGLVERTEXATTRIB4NBVARBPROC *PFNGLVERTEXATTRIB4NBVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NIVARBPROC) (GLuint index, const GLint *v);
typedef FNGLVERTEXATTRIB4NIVARBPROC *PFNGLVERTEXATTRIB4NIVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NSVARBPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB4NSVARBPROC *PFNGLVERTEXATTRIB4NSVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NUBARBPROC) (GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
typedef FNGLVERTEXATTRIB4NUBARBPROC *PFNGLVERTEXATTRIB4NUBARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NUBVARBPROC) (GLuint index, const GLubyte *v);
typedef FNGLVERTEXATTRIB4NUBVARBPROC *PFNGLVERTEXATTRIB4NUBVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NUIVARBPROC) (GLuint index, const GLuint *v);
typedef FNGLVERTEXATTRIB4NUIVARBPROC *PFNGLVERTEXATTRIB4NUIVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4NUSVARBPROC) (GLuint index, const GLushort *v);
typedef FNGLVERTEXATTRIB4NUSVARBPROC *PFNGLVERTEXATTRIB4NUSVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4BVARBPROC) (GLuint index, const GLbyte *v);
typedef FNGLVERTEXATTRIB4BVARBPROC *PFNGLVERTEXATTRIB4BVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4DARBPROC) (GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLVERTEXATTRIB4DARBPROC *PFNGLVERTEXATTRIB4DARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4DVARBPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB4DVARBPROC *PFNGLVERTEXATTRIB4DVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4FARBPROC) (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLVERTEXATTRIB4FARBPROC *PFNGLVERTEXATTRIB4FARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4FVARBPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB4FVARBPROC *PFNGLVERTEXATTRIB4FVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4IVARBPROC) (GLuint index, const GLint *v);
typedef FNGLVERTEXATTRIB4IVARBPROC *PFNGLVERTEXATTRIB4IVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4SARBPROC) (GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
typedef FNGLVERTEXATTRIB4SARBPROC *PFNGLVERTEXATTRIB4SARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4SVARBPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB4SVARBPROC *PFNGLVERTEXATTRIB4SVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4UBVARBPROC) (GLuint index, const GLubyte *v);
typedef FNGLVERTEXATTRIB4UBVARBPROC *PFNGLVERTEXATTRIB4UBVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4UIVARBPROC) (GLuint index, const GLuint *v);
typedef FNGLVERTEXATTRIB4UIVARBPROC *PFNGLVERTEXATTRIB4UIVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4USVARBPROC) (GLuint index, const GLushort *v);
typedef FNGLVERTEXATTRIB4USVARBPROC *PFNGLVERTEXATTRIB4USVARBPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBPOINTERARBPROC) (GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride, const GLvoid *pointer);
typedef FNGLVERTEXATTRIBPOINTERARBPROC *PFNGLVERTEXATTRIBPOINTERARBPROC;
typedef void (APIENTRY FNGLENABLEVERTEXATTRIBARRAYARBPROC) (GLuint index);
typedef FNGLENABLEVERTEXATTRIBARRAYARBPROC *PFNGLENABLEVERTEXATTRIBARRAYARBPROC;
typedef void (APIENTRY FNGLDISABLEVERTEXATTRIBARRAYARBPROC) (GLuint index);
typedef FNGLDISABLEVERTEXATTRIBARRAYARBPROC *PFNGLDISABLEVERTEXATTRIBARRAYARBPROC;
typedef void (APIENTRY FNGLPROGRAMSTRINGARBPROC) (GLenum target, GLenum format, GLsizei len, const GLvoid *string);
typedef FNGLPROGRAMSTRINGARBPROC *PFNGLPROGRAMSTRINGARBPROC;
typedef void (APIENTRY FNGLBINDPROGRAMARBPROC) (GLenum target, GLuint program);
typedef FNGLBINDPROGRAMARBPROC *PFNGLBINDPROGRAMARBPROC;
typedef void (APIENTRY FNGLDELETEPROGRAMSARBPROC) (GLsizei n, const GLuint *programs);
typedef FNGLDELETEPROGRAMSARBPROC *PFNGLDELETEPROGRAMSARBPROC;
typedef void (APIENTRY FNGLGENPROGRAMSARBPROC) (GLsizei n, GLuint *programs);
typedef FNGLGENPROGRAMSARBPROC *PFNGLGENPROGRAMSARBPROC;
typedef void (APIENTRY FNGLPROGRAMENVPARAMETER4DARBPROC) (GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLPROGRAMENVPARAMETER4DARBPROC *PFNGLPROGRAMENVPARAMETER4DARBPROC;
typedef void (APIENTRY FNGLPROGRAMENVPARAMETER4DVARBPROC) (GLenum target, GLuint index, const GLdouble *params);
typedef FNGLPROGRAMENVPARAMETER4DVARBPROC *PFNGLPROGRAMENVPARAMETER4DVARBPROC;
typedef void (APIENTRY FNGLPROGRAMENVPARAMETER4FARBPROC) (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLPROGRAMENVPARAMETER4FARBPROC *PFNGLPROGRAMENVPARAMETER4FARBPROC;
typedef void (APIENTRY FNGLPROGRAMENVPARAMETER4FVARBPROC) (GLenum target, GLuint index, const GLfloat *params);
typedef FNGLPROGRAMENVPARAMETER4FVARBPROC *PFNGLPROGRAMENVPARAMETER4FVARBPROC;
typedef void (APIENTRY FNGLPROGRAMLOCALPARAMETER4DARBPROC) (GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLPROGRAMLOCALPARAMETER4DARBPROC *PFNGLPROGRAMLOCALPARAMETER4DARBPROC;
typedef void (APIENTRY FNGLPROGRAMLOCALPARAMETER4DVARBPROC) (GLenum target, GLuint index, const GLdouble *params);
typedef FNGLPROGRAMLOCALPARAMETER4DVARBPROC *PFNGLPROGRAMLOCALPARAMETER4DVARBPROC;
typedef void (APIENTRY FNGLPROGRAMLOCALPARAMETER4FARBPROC) (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLPROGRAMLOCALPARAMETER4FARBPROC *PFNGLPROGRAMLOCALPARAMETER4FARBPROC;
typedef void (APIENTRY FNGLPROGRAMLOCALPARAMETER4FVARBPROC) (GLenum target, GLuint index, const GLfloat *params);
typedef FNGLPROGRAMLOCALPARAMETER4FVARBPROC *PFNGLPROGRAMLOCALPARAMETER4FVARBPROC;
typedef void (APIENTRY FNGLGETPROGRAMENVPARAMETERDVARBPROC) (GLenum target, GLuint index, GLdouble *params);
typedef FNGLGETPROGRAMENVPARAMETERDVARBPROC *PFNGLGETPROGRAMENVPARAMETERDVARBPROC;
typedef void (APIENTRY FNGLGETPROGRAMENVPARAMETERFVARBPROC) (GLenum target, GLuint index, GLfloat *params);
typedef FNGLGETPROGRAMENVPARAMETERFVARBPROC *PFNGLGETPROGRAMENVPARAMETERFVARBPROC;
typedef void (APIENTRY FNGLGETPROGRAMLOCALPARAMETERDVARBPROC) (GLenum target, GLuint index, GLdouble *params);
typedef FNGLGETPROGRAMLOCALPARAMETERDVARBPROC *PFNGLGETPROGRAMLOCALPARAMETERDVARBPROC;
typedef void (APIENTRY FNGLGETPROGRAMLOCALPARAMETERFVARBPROC) (GLenum target, GLuint index, GLfloat *params);
typedef FNGLGETPROGRAMLOCALPARAMETERFVARBPROC *PFNGLGETPROGRAMLOCALPARAMETERFVARBPROC;
typedef void (APIENTRY FNGLGETPROGRAMIVARBPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETPROGRAMIVARBPROC *PFNGLGETPROGRAMIVARBPROC;
typedef void (APIENTRY FNGLGETPROGRAMSTRINGARBPROC) (GLenum target, GLenum pname, GLvoid *string);
typedef FNGLGETPROGRAMSTRINGARBPROC *PFNGLGETPROGRAMSTRINGARBPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBDVARBPROC) (GLuint index, GLenum pname, GLdouble *params);
typedef FNGLGETVERTEXATTRIBDVARBPROC *PFNGLGETVERTEXATTRIBDVARBPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBFVARBPROC) (GLuint index, GLenum pname, GLfloat *params);
typedef FNGLGETVERTEXATTRIBFVARBPROC *PFNGLGETVERTEXATTRIBFVARBPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBIVARBPROC) (GLuint index, GLenum pname, GLint *params);
typedef FNGLGETVERTEXATTRIBIVARBPROC *PFNGLGETVERTEXATTRIBIVARBPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBPOINTERVARBPROC) (GLuint index, GLenum pname, GLvoid* *pointer);
typedef FNGLGETVERTEXATTRIBPOINTERVARBPROC *PFNGLGETVERTEXATTRIBPOINTERVARBPROC;
typedef GLboolean (APIENTRY FNGLISPROGRAMARBPROC) (GLuint program);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLBLENDCOLOREXTPROC) (GLclampf red, GLclampf green, GLclampf blue, GLclampf alpha);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPOLYGONOFFSETEXTPROC) (GLfloat factor, GLfloat bias);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTEXIMAGE3DEXTPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
typedef FNGLTEXIMAGE3DEXTPROC *PFNGLTEXIMAGE3DEXTPROC;
typedef void (APIENTRY FNGLTEXSUBIMAGE3DEXTPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLsizei width, GLsizei height, GLsizei depth, GLenum format, GLenum type, const GLvoid *pixels);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLGETTEXFILTERFUNCSGISPROC) (GLenum target, GLenum filter, GLfloat *weights);
typedef FNGLGETTEXFILTERFUNCSGISPROC *PFNGLGETTEXFILTERFUNCSGISPROC;
typedef void (APIENTRY FNGLTEXFILTERFUNCSGISPROC) (GLenum target, GLenum filter, GLsizei n, const GLfloat *weights);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTEXSUBIMAGE1DEXTPROC) (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels);
typedef FNGLTEXSUBIMAGE1DEXTPROC *PFNGLTEXSUBIMAGE1DEXTPROC;
typedef void (APIENTRY FNGLTEXSUBIMAGE2DEXTPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOPYTEXIMAGE1DEXTPROC) (GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLint border);
typedef FNGLCOPYTEXIMAGE1DEXTPROC *PFNGLCOPYTEXIMAGE1DEXTPROC;
typedef void (APIENTRY FNGLCOPYTEXIMAGE2DEXTPROC) (GLenum target, GLint level, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height, GLint border);
typedef FNGLCOPYTEXIMAGE2DEXTPROC *PFNGLCOPYTEXIMAGE2DEXTPROC;
typedef void (APIENTRY FNGLCOPYTEXSUBIMAGE1DEXTPROC) (GLenum target, GLint level, GLint xoffset, GLint x, GLint y, GLsizei width);
typedef FNGLCOPYTEXSUBIMAGE1DEXTPROC *PFNGLCOPYTEXSUBIMAGE1DEXTPROC;
typedef void (APIENTRY FNGLCOPYTEXSUBIMAGE2DEXTPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint x, GLint y, GLsizei width, GLsizei height);
typedef FNGLCOPYTEXSUBIMAGE2DEXTPROC *PFNGLCOPYTEXSUBIMAGE2DEXTPROC;
typedef void (APIENTRY FNGLCOPYTEXSUBIMAGE3DEXTPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint x, GLint y, GLsizei width, GLsizei height);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLGETHISTOGRAMEXTPROC) (GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values);
typedef FNGLGETHISTOGRAMEXTPROC *PFNGLGETHISTOGRAMEXTPROC;
typedef void (APIENTRY FNGLGETHISTOGRAMPARAMETERFVEXTPROC) (GLenum target, GLenum pname, GLfloat *params);
typedef FNGLGETHISTOGRAMPARAMETERFVEXTPROC *PFNGLGETHISTOGRAMPARAMETERFVEXTPROC;
typedef void (APIENTRY FNGLGETHISTOGRAMPARAMETERIVEXTPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETHISTOGRAMPARAMETERIVEXTPROC *PFNGLGETHISTOGRAMPARAMETERIVEXTPROC;
typedef void (APIENTRY FNGLGETMINMAXEXTPROC) (GLenum target, GLboolean reset, GLenum format, GLenum type, GLvoid *values);
typedef FNGLGETMINMAXEXTPROC *PFNGLGETMINMAXEXTPROC;
typedef void (APIENTRY FNGLGETMINMAXPARAMETERFVEXTPROC) (GLenum target, GLenum pname, GLfloat *params);
typedef FNGLGETMINMAXPARAMETERFVEXTPROC *PFNGLGETMINMAXPARAMETERFVEXTPROC;
typedef void (APIENTRY FNGLGETMINMAXPARAMETERIVEXTPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETMINMAXPARAMETERIVEXTPROC *PFNGLGETMINMAXPARAMETERIVEXTPROC;
typedef void (APIENTRY FNGLHISTOGRAMEXTPROC) (GLenum target, GLsizei width, GLenum internalformat, GLboolean sink);
typedef FNGLHISTOGRAMEXTPROC *PFNGLHISTOGRAMEXTPROC;
typedef void (APIENTRY FNGLMINMAXEXTPROC) (GLenum target, GLenum internalformat, GLboolean sink);
typedef FNGLMINMAXEXTPROC *PFNGLMINMAXEXTPROC;
typedef void (APIENTRY FNGLRESETHISTOGRAMEXTPROC) (GLenum target);
typedef FNGLRESETHISTOGRAMEXTPROC *PFNGLRESETHISTOGRAMEXTPROC;
typedef void (APIENTRY FNGLRESETMINMAXEXTPROC) (GLenum target);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCONVOLUTIONFILTER1DEXTPROC) (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *image);
typedef FNGLCONVOLUTIONFILTER1DEXTPROC *PFNGLCONVOLUTIONFILTER1DEXTPROC;
typedef void (APIENTRY FNGLCONVOLUTIONFILTER2DEXTPROC) (GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *image);
typedef FNGLCONVOLUTIONFILTER2DEXTPROC *PFNGLCONVOLUTIONFILTER2DEXTPROC;
typedef void (APIENTRY FNGLCONVOLUTIONPARAMETERFEXTPROC) (GLenum target, GLenum pname, GLfloat params);
typedef FNGLCONVOLUTIONPARAMETERFEXTPROC *PFNGLCONVOLUTIONPARAMETERFEXTPROC;
typedef void (APIENTRY FNGLCONVOLUTIONPARAMETERFVEXTPROC) (GLenum target, GLenum pname, const GLfloat *params);
typedef FNGLCONVOLUTIONPARAMETERFVEXTPROC *PFNGLCONVOLUTIONPARAMETERFVEXTPROC;
typedef void (APIENTRY FNGLCONVOLUTIONPARAMETERIEXTPROC) (GLenum target, GLenum pname, GLint params);
typedef FNGLCONVOLUTIONPARAMETERIEXTPROC *PFNGLCONVOLUTIONPARAMETERIEXTPROC;
typedef void (APIENTRY FNGLCONVOLUTIONPARAMETERIVEXTPROC) (GLenum target, GLenum pname, const GLint *params);
typedef FNGLCONVOLUTIONPARAMETERIVEXTPROC *PFNGLCONVOLUTIONPARAMETERIVEXTPROC;
typedef void (APIENTRY FNGLCOPYCONVOLUTIONFILTER1DEXTPROC) (GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width);
typedef FNGLCOPYCONVOLUTIONFILTER1DEXTPROC *PFNGLCOPYCONVOLUTIONFILTER1DEXTPROC;
typedef void (APIENTRY FNGLCOPYCONVOLUTIONFILTER2DEXTPROC) (GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width, GLsizei height);
typedef FNGLCOPYCONVOLUTIONFILTER2DEXTPROC *PFNGLCOPYCONVOLUTIONFILTER2DEXTPROC;
typedef void (APIENTRY FNGLGETCONVOLUTIONFILTEREXTPROC) (GLenum target, GLenum format, GLenum type, GLvoid *image);
typedef FNGLGETCONVOLUTIONFILTEREXTPROC *PFNGLGETCONVOLUTIONFILTEREXTPROC;
typedef void (APIENTRY FNGLGETCONVOLUTIONPARAMETERFVEXTPROC) (GLenum target, GLenum pname, GLfloat *params);
typedef FNGLGETCONVOLUTIONPARAMETERFVEXTPROC *PFNGLGETCONVOLUTIONPARAMETERFVEXTPROC;
typedef void (APIENTRY FNGLGETCONVOLUTIONPARAMETERIVEXTPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETCONVOLUTIONPARAMETERIVEXTPROC *PFNGLGETCONVOLUTIONPARAMETERIVEXTPROC;
typedef void (APIENTRY FNGLGETSEPARABLEFILTEREXTPROC) (GLenum target, GLenum format, GLenum type, GLvoid *row, GLvoid *column, GLvoid *span);
typedef FNGLGETSEPARABLEFILTEREXTPROC *PFNGLGETSEPARABLEFILTEREXTPROC;
typedef void (APIENTRY FNGLSEPARABLEFILTER2DEXTPROC) (GLenum target, GLenum internalformat, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *row, const GLvoid *column);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOLORTABLESGIPROC) (GLenum target, GLenum internalformat, GLsizei width, GLenum format, GLenum type, const GLvoid *table);
typedef FNGLCOLORTABLESGIPROC *PFNGLCOLORTABLESGIPROC;
typedef void (APIENTRY FNGLCOLORTABLEPARAMETERFVSGIPROC) (GLenum target, GLenum pname, const GLfloat *params);
typedef FNGLCOLORTABLEPARAMETERFVSGIPROC *PFNGLCOLORTABLEPARAMETERFVSGIPROC;
typedef void (APIENTRY FNGLCOLORTABLEPARAMETERIVSGIPROC) (GLenum target, GLenum pname, const GLint *params);
typedef FNGLCOLORTABLEPARAMETERIVSGIPROC *PFNGLCOLORTABLEPARAMETERIVSGIPROC;
typedef void (APIENTRY FNGLCOPYCOLORTABLESGIPROC) (GLenum target, GLenum internalformat, GLint x, GLint y, GLsizei width);
typedef FNGLCOPYCOLORTABLESGIPROC *PFNGLCOPYCOLORTABLESGIPROC;
typedef void (APIENTRY FNGLGETCOLORTABLESGIPROC) (GLenum target, GLenum format, GLenum type, GLvoid *table);
typedef FNGLGETCOLORTABLESGIPROC *PFNGLGETCOLORTABLESGIPROC;
typedef void (APIENTRY FNGLGETCOLORTABLEPARAMETERFVSGIPROC) (GLenum target, GLenum pname, GLfloat *params);
typedef FNGLGETCOLORTABLEPARAMETERFVSGIPROC *PFNGLGETCOLORTABLEPARAMETERFVSGIPROC;
typedef void (APIENTRY FNGLGETCOLORTABLEPARAMETERIVSGIPROC) (GLenum target, GLenum pname, GLint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPIXELTEXGENSGIXPROC) (GLenum mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPIXELTEXGENPARAMETERISGISPROC) (GLenum pname, GLint param);
typedef FNGLPIXELTEXGENPARAMETERISGISPROC *PFNGLPIXELTEXGENPARAMETERISGISPROC;
typedef void (APIENTRY FNGLPIXELTEXGENPARAMETERIVSGISPROC) (GLenum pname, const GLint *params);
typedef FNGLPIXELTEXGENPARAMETERIVSGISPROC *PFNGLPIXELTEXGENPARAMETERIVSGISPROC;
typedef void (APIENTRY FNGLPIXELTEXGENPARAMETERFSGISPROC) (GLenum pname, GLfloat param);
typedef FNGLPIXELTEXGENPARAMETERFSGISPROC *PFNGLPIXELTEXGENPARAMETERFSGISPROC;
typedef void (APIENTRY FNGLPIXELTEXGENPARAMETERFVSGISPROC) (GLenum pname, const GLfloat *params);
typedef FNGLPIXELTEXGENPARAMETERFVSGISPROC *PFNGLPIXELTEXGENPARAMETERFVSGISPROC;
typedef void (APIENTRY FNGLGETPIXELTEXGENPARAMETERIVSGISPROC) (GLenum pname, GLint *params);
typedef FNGLGETPIXELTEXGENPARAMETERIVSGISPROC *PFNGLGETPIXELTEXGENPARAMETERIVSGISPROC;
typedef void (APIENTRY FNGLGETPIXELTEXGENPARAMETERFVSGISPROC) (GLenum pname, GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTEXIMAGE4DSGISPROC) (GLenum target, GLint level, GLenum internalformat, GLsizei width, GLsizei height, GLsizei depth, GLsizei size4d, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
typedef FNGLTEXIMAGE4DSGISPROC *PFNGLTEXIMAGE4DSGISPROC;
typedef void (APIENTRY FNGLTEXSUBIMAGE4DSGISPROC) (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLint zoffset, GLint woffset, GLsizei width, GLsizei height, GLsizei depth, GLsizei size4d, GLenum format, GLenum type, const GLvoid *pixels);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef GLboolean (APIENTRY FNGLARETEXTURESRESIDENTEXTPROC) (GLsizei n, const GLuint *textures, GLboolean *residences);
typedef FNGLARETEXTURESRESIDENTEXTPROC *PFNGLARETEXTURESRESIDENTEXTPROC;
typedef void (APIENTRY FNGLBINDTEXTUREEXTPROC) (GLenum target, GLuint texture);
typedef FNGLBINDTEXTUREEXTPROC *PFNGLBINDTEXTUREEXTPROC;
typedef void (APIENTRY FNGLDELETETEXTURESEXTPROC) (GLsizei n, const GLuint *textures);
typedef FNGLDELETETEXTURESEXTPROC *PFNGLDELETETEXTURESEXTPROC;
typedef void (APIENTRY FNGLGENTEXTURESEXTPROC) (GLsizei n, GLuint *textures);
typedef FNGLGENTEXTURESEXTPROC *PFNGLGENTEXTURESEXTPROC;
typedef GLboolean (APIENTRY FNGLISTEXTUREEXTPROC) (GLuint texture);
typedef FNGLISTEXTUREEXTPROC *PFNGLISTEXTUREEXTPROC;
typedef void (APIENTRY FNGLPRIORITIZETEXTURESEXTPROC) (GLsizei n, const GLuint *textures, const GLclampf *priorities);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLDETAILTEXFUNCSGISPROC) (GLenum target, GLsizei n, const GLfloat *points);
typedef FNGLDETAILTEXFUNCSGISPROC *PFNGLDETAILTEXFUNCSGISPROC;
typedef void (APIENTRY FNGLGETDETAILTEXFUNCSGISPROC) (GLenum target, GLfloat *points);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLSHARPENTEXFUNCSGISPROC) (GLenum target, GLsizei n, const GLfloat *points);
typedef FNGLSHARPENTEXFUNCSGISPROC *PFNGLSHARPENTEXFUNCSGISPROC;
typedef void (APIENTRY FNGLGETSHARPENTEXFUNCSGISPROC) (GLenum target, GLfloat *points);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLSAMPLEMASKSGISPROC) (GLclampf value, GLboolean invert);
typedef FNGLSAMPLEMASKSGISPROC *PFNGLSAMPLEMASKSGISPROC;
typedef void (APIENTRY FNGLSAMPLEPATTERNSGISPROC) (GLenum pattern);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLARRAYELEMENTEXTPROC) (GLint i);
typedef FNGLARRAYELEMENTEXTPROC *PFNGLARRAYELEMENTEXTPROC;
typedef void (APIENTRY FNGLCOLORPOINTEREXTPROC) (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
typedef FNGLCOLORPOINTEREXTPROC *PFNGLCOLORPOINTEREXTPROC;
typedef void (APIENTRY FNGLDRAWARRAYSEXTPROC) (GLenum mode, GLint first, GLsizei count);
typedef FNGLDRAWARRAYSEXTPROC *PFNGLDRAWARRAYSEXTPROC;
typedef void (APIENTRY FNGLEDGEFLAGPOINTEREXTPROC) (GLsizei stride, GLsizei count, const GLboolean *pointer);
typedef FNGLEDGEFLAGPOINTEREXTPROC *PFNGLEDGEFLAGPOINTEREXTPROC;
typedef void (APIENTRY FNGLGETPOINTERVEXTPROC) (GLenum pname, GLvoid* *params);
typedef FNGLGETPOINTERVEXTPROC *PFNGLGETPOINTERVEXTPROC;
typedef void (APIENTRY FNGLINDEXPOINTEREXTPROC) (GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
typedef FNGLINDEXPOINTEREXTPROC *PFNGLINDEXPOINTEREXTPROC;
typedef void (APIENTRY FNGLNORMALPOINTEREXTPROC) (GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
typedef FNGLNORMALPOINTEREXTPROC *PFNGLNORMALPOINTEREXTPROC;
typedef void (APIENTRY FNGLTEXCOORDPOINTEREXTPROC) (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
typedef FNGLTEXCOORDPOINTEREXTPROC *PFNGLTEXCOORDPOINTEREXTPROC;
typedef void (APIENTRY FNGLVERTEXPOINTEREXTPROC) (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLBLENDEQUATIONEXTPROC) (GLenum mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLSPRITEPARAMETERFSGIXPROC) (GLenum pname, GLfloat param);
typedef FNGLSPRITEPARAMETERFSGIXPROC *PFNGLSPRITEPARAMETERFSGIXPROC;
typedef void (APIENTRY FNGLSPRITEPARAMETERFVSGIXPROC) (GLenum pname, const GLfloat *params);
typedef FNGLSPRITEPARAMETERFVSGIXPROC *PFNGLSPRITEPARAMETERFVSGIXPROC;
typedef void (APIENTRY FNGLSPRITEPARAMETERISGIXPROC) (GLenum pname, GLint param);
typedef FNGLSPRITEPARAMETERISGIXPROC *PFNGLSPRITEPARAMETERISGIXPROC;
typedef void (APIENTRY FNGLSPRITEPARAMETERIVSGIXPROC) (GLenum pname, const GLint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPOINTPARAMETERFEXTPROC) (GLenum pname, GLfloat param);
typedef FNGLPOINTPARAMETERFEXTPROC *PFNGLPOINTPARAMETERFEXTPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERFVEXTPROC) (GLenum pname, const GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPOINTPARAMETERFSGISPROC) (GLenum pname, GLfloat param);
typedef FNGLPOINTPARAMETERFSGISPROC *PFNGLPOINTPARAMETERFSGISPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERFVSGISPROC) (GLenum pname, const GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef GLint (APIENTRY FNGLGETINSTRUMENTSSGIXPROC) (void);
typedef FNGLGETINSTRUMENTSSGIXPROC *PFNGLGETINSTRUMENTSSGIXPROC;
typedef void (APIENTRY FNGLINSTRUMENTSBUFFERSGIXPROC) (GLsizei size, GLint *buffer);
typedef FNGLINSTRUMENTSBUFFERSGIXPROC *PFNGLINSTRUMENTSBUFFERSGIXPROC;
typedef GLint (APIENTRY FNGLPOLLINSTRUMENTSSGIXPROC) (GLint *marker_p);
typedef FNGLPOLLINSTRUMENTSSGIXPROC *PFNGLPOLLINSTRUMENTSSGIXPROC;
typedef void (APIENTRY FNGLREADINSTRUMENTSSGIXPROC) (GLint marker);
typedef FNGLREADINSTRUMENTSSGIXPROC *PFNGLREADINSTRUMENTSSGIXPROC;
typedef void (APIENTRY FNGLSTARTINSTRUMENTSSGIXPROC) (void);
typedef FNGLSTARTINSTRUMENTSSGIXPROC *PFNGLSTARTINSTRUMENTSSGIXPROC;
typedef void (APIENTRY FNGLSTOPINSTRUMENTSSGIXPROC) (GLint marker);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFRAMEZOOMSGIXPROC) (GLint factor);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTAGSAMPLEBUFFERSGIXPROC) (void);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLDEFORMATIONMAP3DSGIXPROC) (GLenum target, GLdouble u1, GLdouble u2, GLint ustride, GLint uorder, GLdouble v1, GLdouble v2, GLint vstride, GLint vorder, GLdouble w1, GLdouble w2, GLint wstride, GLint worder, const GLdouble *points);
typedef FNGLDEFORMATIONMAP3DSGIXPROC *PFNGLDEFORMATIONMAP3DSGIXPROC;
typedef void (APIENTRY FNGLDEFORMATIONMAP3FSGIXPROC) (GLenum target, GLfloat u1, GLfloat u2, GLint ustride, GLint uorder, GLfloat v1, GLfloat v2, GLint vstride, GLint vorder, GLfloat w1, GLfloat w2, GLint wstride, GLint worder, const GLfloat *points);
typedef FNGLDEFORMATIONMAP3FSGIXPROC *PFNGLDEFORMATIONMAP3FSGIXPROC;
typedef void (APIENTRY FNGLDEFORMSGIXPROC) (GLbitfield mask);
typedef FNGLDEFORMSGIXPROC *PFNGLDEFORMSGIXPROC;
typedef void (APIENTRY FNGLLOADIDENTITYDEFORMATIONMAPSGIXPROC) (GLbitfield mask);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLREFERENCEPLANESGIXPROC) (const GLdouble *equation);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFLUSHRASTERSGIXPROC) (void);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFOGFUNCSGISPROC) (GLsizei n, const GLfloat *points);
typedef FNGLFOGFUNCSGISPROC *PFNGLFOGFUNCSGISPROC;
typedef void (APIENTRY FNGLGETFOGFUNCSGISPROC) (GLfloat *points);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLIMAGETRANSFORMPARAMETERIHPPROC) (GLenum target, GLenum pname, GLint param);
typedef FNGLIMAGETRANSFORMPARAMETERIHPPROC *PFNGLIMAGETRANSFORMPARAMETERIHPPROC;
typedef void (APIENTRY FNGLIMAGETRANSFORMPARAMETERFHPPROC) (GLenum target, GLenum pname, GLfloat param);
typedef FNGLIMAGETRANSFORMPARAMETERFHPPROC *PFNGLIMAGETRANSFORMPARAMETERFHPPROC;
typedef void (APIENTRY FNGLIMAGETRANSFORMPARAMETERIVHPPROC) (GLenum target, GLenum pname, const GLint *params);
typedef FNGLIMAGETRANSFORMPARAMETERIVHPPROC *PFNGLIMAGETRANSFORMPARAMETERIVHPPROC;
typedef void (APIENTRY FNGLIMAGETRANSFORMPARAMETERFVHPPROC) (GLenum target, GLenum pname, const GLfloat *params);
typedef FNGLIMAGETRANSFORMPARAMETERFVHPPROC *PFNGLIMAGETRANSFORMPARAMETERFVHPPROC;
typedef void (APIENTRY FNGLGETIMAGETRANSFORMPARAMETERIVHPPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETIMAGETRANSFORMPARAMETERIVHPPROC *PFNGLGETIMAGETRANSFORMPARAMETERIVHPPROC;
typedef void (APIENTRY FNGLGETIMAGETRANSFORMPARAMETERFVHPPROC) (GLenum target, GLenum pname, GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOLORSUBTABLEEXTPROC) (GLenum target, GLsizei start, GLsizei count, GLenum format, GLenum type, const GLvoid *data);
typedef FNGLCOLORSUBTABLEEXTPROC *PFNGLCOLORSUBTABLEEXTPROC;
typedef void (APIENTRY FNGLCOPYCOLORSUBTABLEEXTPROC) (GLenum target, GLsizei start, GLint x, GLint y, GLsizei width);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLHINTPGIPROC) (GLenum target, GLint mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOLORTABLEEXTPROC) (GLenum target, GLenum internalFormat, GLsizei width, GLenum format, GLenum type, const GLvoid *table);
typedef FNGLCOLORTABLEEXTPROC *PFNGLCOLORTABLEEXTPROC;
typedef void (APIENTRY FNGLGETCOLORTABLEEXTPROC) (GLenum target, GLenum format, GLenum type, GLvoid *data);
typedef FNGLGETCOLORTABLEEXTPROC *PFNGLGETCOLORTABLEEXTPROC;
typedef void (APIENTRY FNGLGETCOLORTABLEPARAMETERIVEXTPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETCOLORTABLEPARAMETERIVEXTPROC *PFNGLGETCOLORTABLEPARAMETERIVEXTPROC;
typedef void (APIENTRY FNGLGETCOLORTABLEPARAMETERFVEXTPROC) (GLenum target, GLenum pname, GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLGETLISTPARAMETERFVSGIXPROC) (GLuint list, GLenum pname, GLfloat *params);
typedef FNGLGETLISTPARAMETERFVSGIXPROC *PFNGLGETLISTPARAMETERFVSGIXPROC;
typedef void (APIENTRY FNGLGETLISTPARAMETERIVSGIXPROC) (GLuint list, GLenum pname, GLint *params);
typedef FNGLGETLISTPARAMETERIVSGIXPROC *PFNGLGETLISTPARAMETERIVSGIXPROC;
typedef void (APIENTRY FNGLLISTPARAMETERFSGIXPROC) (GLuint list, GLenum pname, GLfloat param);
typedef FNGLLISTPARAMETERFSGIXPROC *PFNGLLISTPARAMETERFSGIXPROC;
typedef void (APIENTRY FNGLLISTPARAMETERFVSGIXPROC) (GLuint list, GLenum pname, const GLfloat *params);
typedef FNGLLISTPARAMETERFVSGIXPROC *PFNGLLISTPARAMETERFVSGIXPROC;
typedef void (APIENTRY FNGLLISTPARAMETERISGIXPROC) (GLuint list, GLenum pname, GLint param);
typedef FNGLLISTPARAMETERISGIXPROC *PFNGLLISTPARAMETERISGIXPROC;
typedef void (APIENTRY FNGLLISTPARAMETERIVSGIXPROC) (GLuint list, GLenum pname, const GLint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLINDEXMATERIALEXTPROC) (GLenum face, GLenum mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLINDEXFUNCEXTPROC) (GLenum func, GLclampf ref);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLLOCKARRAYSEXTPROC) (GLint first, GLsizei count);
typedef FNGLLOCKARRAYSEXTPROC *PFNGLLOCKARRAYSEXTPROC;
typedef void (APIENTRY FNGLUNLOCKARRAYSEXTPROC) (void);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCULLPARAMETERDVEXTPROC) (GLenum pname, GLdouble *params);
typedef FNGLCULLPARAMETERDVEXTPROC *PFNGLCULLPARAMETERDVEXTPROC;
typedef void (APIENTRY FNGLCULLPARAMETERFVEXTPROC) (GLenum pname, GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFRAGMENTCOLORMATERIALSGIXPROC) (GLenum face, GLenum mode);
typedef FNGLFRAGMENTCOLORMATERIALSGIXPROC *PFNGLFRAGMENTCOLORMATERIALSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTFSGIXPROC) (GLenum light, GLenum pname, GLfloat param);
typedef FNGLFRAGMENTLIGHTFSGIXPROC *PFNGLFRAGMENTLIGHTFSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTFVSGIXPROC) (GLenum light, GLenum pname, const GLfloat *params);
typedef FNGLFRAGMENTLIGHTFVSGIXPROC *PFNGLFRAGMENTLIGHTFVSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTISGIXPROC) (GLenum light, GLenum pname, GLint param);
typedef FNGLFRAGMENTLIGHTISGIXPROC *PFNGLFRAGMENTLIGHTISGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTIVSGIXPROC) (GLenum light, GLenum pname, const GLint *params);
typedef FNGLFRAGMENTLIGHTIVSGIXPROC *PFNGLFRAGMENTLIGHTIVSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTMODELFSGIXPROC) (GLenum pname, GLfloat param);
typedef FNGLFRAGMENTLIGHTMODELFSGIXPROC *PFNGLFRAGMENTLIGHTMODELFSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTMODELFVSGIXPROC) (GLenum pname, const GLfloat *params);
typedef FNGLFRAGMENTLIGHTMODELFVSGIXPROC *PFNGLFRAGMENTLIGHTMODELFVSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTMODELISGIXPROC) (GLenum pname, GLint param);
typedef FNGLFRAGMENTLIGHTMODELISGIXPROC *PFNGLFRAGMENTLIGHTMODELISGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTLIGHTMODELIVSGIXPROC) (GLenum pname, const GLint *params);
typedef FNGLFRAGMENTLIGHTMODELIVSGIXPROC *PFNGLFRAGMENTLIGHTMODELIVSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTMATERIALFSGIXPROC) (GLenum face, GLenum pname, GLfloat param);
typedef FNGLFRAGMENTMATERIALFSGIXPROC *PFNGLFRAGMENTMATERIALFSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTMATERIALFVSGIXPROC) (GLenum face, GLenum pname, const GLfloat *params);
typedef FNGLFRAGMENTMATERIALFVSGIXPROC *PFNGLFRAGMENTMATERIALFVSGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTMATERIALISGIXPROC) (GLenum face, GLenum pname, GLint param);
typedef FNGLFRAGMENTMATERIALISGIXPROC *PFNGLFRAGMENTMATERIALISGIXPROC;
typedef void (APIENTRY FNGLFRAGMENTMATERIALIVSGIXPROC) (GLenum face, GLenum pname, const GLint *params);
typedef FNGLFRAGMENTMATERIALIVSGIXPROC *PFNGLFRAGMENTMATERIALIVSGIXPROC;
typedef void (APIENTRY FNGLGETFRAGMENTLIGHTFVSGIXPROC) (GLenum light, GLenum pname, GLfloat *params);
typedef FNGLGETFRAGMENTLIGHTFVSGIXPROC *PFNGLGETFRAGMENTLIGHTFVSGIXPROC;
typedef void (APIENTRY FNGLGETFRAGMENTLIGHTIVSGIXPROC) (GLenum light, GLenum pname, GLint *params);
typedef FNGLGETFRAGMENTLIGHTIVSGIXPROC *PFNGLGETFRAGMENTLIGHTIVSGIXPROC;
typedef void (APIENTRY FNGLGETFRAGMENTMATERIALFVSGIXPROC) (GLenum face, GLenum pname, GLfloat *params);
typedef FNGLGETFRAGMENTMATERIALFVSGIXPROC *PFNGLGETFRAGMENTMATERIALFVSGIXPROC;
typedef void (APIENTRY FNGLGETFRAGMENTMATERIALIVSGIXPROC) (GLenum face, GLenum pname, GLint *params);
typedef FNGLGETFRAGMENTMATERIALIVSGIXPROC *PFNGLGETFRAGMENTMATERIALIVSGIXPROC;
typedef void (APIENTRY FNGLLIGHTENVISGIXPROC) (GLenum pname, GLint param);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLDRAWRANGEELEMENTSEXTPROC) (GLenum mode, GLuint start, GLuint end, GLsizei count, GLenum type, const GLvoid *indices);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLAPPLYTEXTUREEXTPROC) (GLenum mode);
typedef FNGLAPPLYTEXTUREEXTPROC *PFNGLAPPLYTEXTUREEXTPROC;
typedef void (APIENTRY FNGLTEXTURELIGHTEXTPROC) (GLenum pname);
typedef FNGLTEXTURELIGHTEXTPROC *PFNGLTEXTURELIGHTEXTPROC;
typedef void (APIENTRY FNGLTEXTUREMATERIALEXTPROC) (GLenum face, GLenum mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLASYNCMARKERSGIXPROC) (GLuint marker);
typedef FNGLASYNCMARKERSGIXPROC *PFNGLASYNCMARKERSGIXPROC;
typedef GLint (APIENTRY FNGLFINISHASYNCSGIXPROC) (GLuint *markerp);
typedef FNGLFINISHASYNCSGIXPROC *PFNGLFINISHASYNCSGIXPROC;
typedef GLint (APIENTRY FNGLPOLLASYNCSGIXPROC) (GLuint *markerp);
typedef FNGLPOLLASYNCSGIXPROC *PFNGLPOLLASYNCSGIXPROC;
typedef GLuint (APIENTRY FNGLGENASYNCMARKERSSGIXPROC) (GLsizei range);
typedef FNGLGENASYNCMARKERSSGIXPROC *PFNGLGENASYNCMARKERSSGIXPROC;
typedef void (APIENTRY FNGLDELETEASYNCMARKERSSGIXPROC) (GLuint marker, GLsizei range);
typedef FNGLDELETEASYNCMARKERSSGIXPROC *PFNGLDELETEASYNCMARKERSSGIXPROC;
typedef GLboolean (APIENTRY FNGLISASYNCMARKERSGIXPROC) (GLuint marker);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLVERTEXPOINTERVINTELPROC) (GLint size, GLenum type, const GLvoid* *pointer);
typedef FNGLVERTEXPOINTERVINTELPROC *PFNGLVERTEXPOINTERVINTELPROC;
typedef void (APIENTRY FNGLNORMALPOINTERVINTELPROC) (GLenum type, const GLvoid* *pointer);
typedef FNGLNORMALPOINTERVINTELPROC *PFNGLNORMALPOINTERVINTELPROC;
typedef void (APIENTRY FNGLCOLORPOINTERVINTELPROC) (GLint size, GLenum type, const GLvoid* *pointer);
typedef FNGLCOLORPOINTERVINTELPROC *PFNGLCOLORPOINTERVINTELPROC;
typedef void (APIENTRY FNGLTEXCOORDPOINTERVINTELPROC) (GLint size, GLenum type, const GLvoid* *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPIXELTRANSFORMPARAMETERIEXTPROC) (GLenum target, GLenum pname, GLint param);
typedef FNGLPIXELTRANSFORMPARAMETERIEXTPROC *PFNGLPIXELTRANSFORMPARAMETERIEXTPROC;
typedef void (APIENTRY FNGLPIXELTRANSFORMPARAMETERFEXTPROC) (GLenum target, GLenum pname, GLfloat param);
typedef FNGLPIXELTRANSFORMPARAMETERFEXTPROC *PFNGLPIXELTRANSFORMPARAMETERFEXTPROC;
typedef void (APIENTRY FNGLPIXELTRANSFORMPARAMETERIVEXTPROC) (GLenum target, GLenum pname, const GLint *params);
typedef FNGLPIXELTRANSFORMPARAMETERIVEXTPROC *PFNGLPIXELTRANSFORMPARAMETERIVEXTPROC;
typedef void (APIENTRY FNGLPIXELTRANSFORMPARAMETERFVEXTPROC) (GLenum target, GLenum pname, const GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLSECONDARYCOLOR3BEXTPROC) (GLbyte red, GLbyte green, GLbyte blue);
typedef FNGLSECONDARYCOLOR3BEXTPROC *PFNGLSECONDARYCOLOR3BEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3BVEXTPROC) (const GLbyte *v);
typedef FNGLSECONDARYCOLOR3BVEXTPROC *PFNGLSECONDARYCOLOR3BVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3DEXTPROC) (GLdouble red, GLdouble green, GLdouble blue);
typedef FNGLSECONDARYCOLOR3DEXTPROC *PFNGLSECONDARYCOLOR3DEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3DVEXTPROC) (const GLdouble *v);
typedef FNGLSECONDARYCOLOR3DVEXTPROC *PFNGLSECONDARYCOLOR3DVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3FEXTPROC) (GLfloat red, GLfloat green, GLfloat blue);
typedef FNGLSECONDARYCOLOR3FEXTPROC *PFNGLSECONDARYCOLOR3FEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3FVEXTPROC) (const GLfloat *v);
typedef FNGLSECONDARYCOLOR3FVEXTPROC *PFNGLSECONDARYCOLOR3FVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3IEXTPROC) (GLint red, GLint green, GLint blue);
typedef FNGLSECONDARYCOLOR3IEXTPROC *PFNGLSECONDARYCOLOR3IEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3IVEXTPROC) (const GLint *v);
typedef FNGLSECONDARYCOLOR3IVEXTPROC *PFNGLSECONDARYCOLOR3IVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3SEXTPROC) (GLshort red, GLshort green, GLshort blue);
typedef FNGLSECONDARYCOLOR3SEXTPROC *PFNGLSECONDARYCOLOR3SEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3SVEXTPROC) (const GLshort *v);
typedef FNGLSECONDARYCOLOR3SVEXTPROC *PFNGLSECONDARYCOLOR3SVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UBEXTPROC) (GLubyte red, GLubyte green, GLubyte blue);
typedef FNGLSECONDARYCOLOR3UBEXTPROC *PFNGLSECONDARYCOLOR3UBEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UBVEXTPROC) (const GLubyte *v);
typedef FNGLSECONDARYCOLOR3UBVEXTPROC *PFNGLSECONDARYCOLOR3UBVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UIEXTPROC) (GLuint red, GLuint green, GLuint blue);
typedef FNGLSECONDARYCOLOR3UIEXTPROC *PFNGLSECONDARYCOLOR3UIEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3UIVEXTPROC) (const GLuint *v);
typedef FNGLSECONDARYCOLOR3UIVEXTPROC *PFNGLSECONDARYCOLOR3UIVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3USEXTPROC) (GLushort red, GLushort green, GLushort blue);
typedef FNGLSECONDARYCOLOR3USEXTPROC *PFNGLSECONDARYCOLOR3USEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLOR3USVEXTPROC) (const GLushort *v);
typedef FNGLSECONDARYCOLOR3USVEXTPROC *PFNGLSECONDARYCOLOR3USVEXTPROC;
typedef void (APIENTRY FNGLSECONDARYCOLORPOINTEREXTPROC) (GLint size, GLenum type, GLsizei stride, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTEXTURENORMALEXTPROC) (GLenum mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLMULTIDRAWARRAYSEXTPROC) (GLenum mode, GLint *first, GLsizei *count, GLsizei primcount);
typedef FNGLMULTIDRAWARRAYSEXTPROC *PFNGLMULTIDRAWARRAYSEXTPROC;
typedef void (APIENTRY FNGLMULTIDRAWELEMENTSEXTPROC) (GLenum mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFOGCOORDFEXTPROC) (GLfloat coord);
typedef FNGLFOGCOORDFEXTPROC *PFNGLFOGCOORDFEXTPROC;
typedef void (APIENTRY FNGLFOGCOORDFVEXTPROC) (const GLfloat *coord);
typedef FNGLFOGCOORDFVEXTPROC *PFNGLFOGCOORDFVEXTPROC;
typedef void (APIENTRY FNGLFOGCOORDDEXTPROC) (GLdouble coord);
typedef FNGLFOGCOORDDEXTPROC *PFNGLFOGCOORDDEXTPROC;
typedef void (APIENTRY FNGLFOGCOORDDVEXTPROC) (const GLdouble *coord);
typedef FNGLFOGCOORDDVEXTPROC *PFNGLFOGCOORDDVEXTPROC;
typedef void (APIENTRY FNGLFOGCOORDPOINTEREXTPROC) (GLenum type, GLsizei stride, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTANGENT3BEXTPROC) (GLbyte tx, GLbyte ty, GLbyte tz);
typedef FNGLTANGENT3BEXTPROC *PFNGLTANGENT3BEXTPROC;
typedef void (APIENTRY FNGLTANGENT3BVEXTPROC) (const GLbyte *v);
typedef FNGLTANGENT3BVEXTPROC *PFNGLTANGENT3BVEXTPROC;
typedef void (APIENTRY FNGLTANGENT3DEXTPROC) (GLdouble tx, GLdouble ty, GLdouble tz);
typedef FNGLTANGENT3DEXTPROC *PFNGLTANGENT3DEXTPROC;
typedef void (APIENTRY FNGLTANGENT3DVEXTPROC) (const GLdouble *v);
typedef FNGLTANGENT3DVEXTPROC *PFNGLTANGENT3DVEXTPROC;
typedef void (APIENTRY FNGLTANGENT3FEXTPROC) (GLfloat tx, GLfloat ty, GLfloat tz);
typedef FNGLTANGENT3FEXTPROC *PFNGLTANGENT3FEXTPROC;
typedef void (APIENTRY FNGLTANGENT3FVEXTPROC) (const GLfloat *v);
typedef FNGLTANGENT3FVEXTPROC *PFNGLTANGENT3FVEXTPROC;
typedef void (APIENTRY FNGLTANGENT3IEXTPROC) (GLint tx, GLint ty, GLint tz);
typedef FNGLTANGENT3IEXTPROC *PFNGLTANGENT3IEXTPROC;
typedef void (APIENTRY FNGLTANGENT3IVEXTPROC) (const GLint *v);
typedef FNGLTANGENT3IVEXTPROC *PFNGLTANGENT3IVEXTPROC;
typedef void (APIENTRY FNGLTANGENT3SEXTPROC) (GLshort tx, GLshort ty, GLshort tz);
typedef FNGLTANGENT3SEXTPROC *PFNGLTANGENT3SEXTPROC;
typedef void (APIENTRY FNGLTANGENT3SVEXTPROC) (const GLshort *v);
typedef FNGLTANGENT3SVEXTPROC *PFNGLTANGENT3SVEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3BEXTPROC) (GLbyte bx, GLbyte by, GLbyte bz);
typedef FNGLBINORMAL3BEXTPROC *PFNGLBINORMAL3BEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3BVEXTPROC) (const GLbyte *v);
typedef FNGLBINORMAL3BVEXTPROC *PFNGLBINORMAL3BVEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3DEXTPROC) (GLdouble bx, GLdouble by, GLdouble bz);
typedef FNGLBINORMAL3DEXTPROC *PFNGLBINORMAL3DEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3DVEXTPROC) (const GLdouble *v);
typedef FNGLBINORMAL3DVEXTPROC *PFNGLBINORMAL3DVEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3FEXTPROC) (GLfloat bx, GLfloat by, GLfloat bz);
typedef FNGLBINORMAL3FEXTPROC *PFNGLBINORMAL3FEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3FVEXTPROC) (const GLfloat *v);
typedef FNGLBINORMAL3FVEXTPROC *PFNGLBINORMAL3FVEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3IEXTPROC) (GLint bx, GLint by, GLint bz);
typedef FNGLBINORMAL3IEXTPROC *PFNGLBINORMAL3IEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3IVEXTPROC) (const GLint *v);
typedef FNGLBINORMAL3IVEXTPROC *PFNGLBINORMAL3IVEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3SEXTPROC) (GLshort bx, GLshort by, GLshort bz);
typedef FNGLBINORMAL3SEXTPROC *PFNGLBINORMAL3SEXTPROC;
typedef void (APIENTRY FNGLBINORMAL3SVEXTPROC) (const GLshort *v);
typedef FNGLBINORMAL3SVEXTPROC *PFNGLBINORMAL3SVEXTPROC;
typedef void (APIENTRY FNGLTANGENTPOINTEREXTPROC) (GLenum type, GLsizei stride, const GLvoid *pointer);
typedef FNGLTANGENTPOINTEREXTPROC *PFNGLTANGENTPOINTEREXTPROC;
typedef void (APIENTRY FNGLBINORMALPOINTEREXTPROC) (GLenum type, GLsizei stride, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFINISHTEXTURESUNXPROC) (void);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLGLOBALALPHAFACTORBSUNPROC) (GLbyte factor);
typedef FNGLGLOBALALPHAFACTORBSUNPROC *PFNGLGLOBALALPHAFACTORBSUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORSSUNPROC) (GLshort factor);
typedef FNGLGLOBALALPHAFACTORSSUNPROC *PFNGLGLOBALALPHAFACTORSSUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORISUNPROC) (GLint factor);
typedef FNGLGLOBALALPHAFACTORISUNPROC *PFNGLGLOBALALPHAFACTORISUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORFSUNPROC) (GLfloat factor);
typedef FNGLGLOBALALPHAFACTORFSUNPROC *PFNGLGLOBALALPHAFACTORFSUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORDSUNPROC) (GLdouble factor);
typedef FNGLGLOBALALPHAFACTORDSUNPROC *PFNGLGLOBALALPHAFACTORDSUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORUBSUNPROC) (GLubyte factor);
typedef FNGLGLOBALALPHAFACTORUBSUNPROC *PFNGLGLOBALALPHAFACTORUBSUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORUSSUNPROC) (GLushort factor);
typedef FNGLGLOBALALPHAFACTORUSSUNPROC *PFNGLGLOBALALPHAFACTORUSSUNPROC;
typedef void (APIENTRY FNGLGLOBALALPHAFACTORUISUNPROC) (GLuint factor);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLREPLACEMENTCODEUISUNPROC) (GLuint code);
typedef FNGLREPLACEMENTCODEUISUNPROC *PFNGLREPLACEMENTCODEUISUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUSSUNPROC) (GLushort code);
typedef FNGLREPLACEMENTCODEUSSUNPROC *PFNGLREPLACEMENTCODEUSSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUBSUNPROC) (GLubyte code);
typedef FNGLREPLACEMENTCODEUBSUNPROC *PFNGLREPLACEMENTCODEUBSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUIVSUNPROC) (const GLuint *code);
typedef FNGLREPLACEMENTCODEUIVSUNPROC *PFNGLREPLACEMENTCODEUIVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUSVSUNPROC) (const GLushort *code);
typedef FNGLREPLACEMENTCODEUSVSUNPROC *PFNGLREPLACEMENTCODEUSVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUBVSUNPROC) (const GLubyte *code);
typedef FNGLREPLACEMENTCODEUBVSUNPROC *PFNGLREPLACEMENTCODEUBVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEPOINTERSUNPROC) (GLenum type, GLsizei stride, const GLvoid* *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOLOR4UBVERTEX2FSUNPROC) (GLubyte r, GLubyte g, GLubyte b, GLubyte a, GLfloat x, GLfloat y);
typedef FNGLCOLOR4UBVERTEX2FSUNPROC *PFNGLCOLOR4UBVERTEX2FSUNPROC;
typedef void (APIENTRY FNGLCOLOR4UBVERTEX2FVSUNPROC) (const GLubyte *c, const GLfloat *v);
typedef FNGLCOLOR4UBVERTEX2FVSUNPROC *PFNGLCOLOR4UBVERTEX2FVSUNPROC;
typedef void (APIENTRY FNGLCOLOR4UBVERTEX3FSUNPROC) (GLubyte r, GLubyte g, GLubyte b, GLubyte a, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLCOLOR4UBVERTEX3FSUNPROC *PFNGLCOLOR4UBVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLCOLOR4UBVERTEX3FVSUNPROC) (const GLubyte *c, const GLfloat *v);
typedef FNGLCOLOR4UBVERTEX3FVSUNPROC *PFNGLCOLOR4UBVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLCOLOR3FVERTEX3FSUNPROC) (GLfloat r, GLfloat g, GLfloat b, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLCOLOR3FVERTEX3FSUNPROC *PFNGLCOLOR3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLCOLOR3FVERTEX3FVSUNPROC) (const GLfloat *c, const GLfloat *v);
typedef FNGLCOLOR3FVERTEX3FVSUNPROC *PFNGLCOLOR3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLNORMAL3FVERTEX3FSUNPROC) (GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLNORMAL3FVERTEX3FSUNPROC *PFNGLNORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLNORMAL3FVERTEX3FVSUNPROC) (const GLfloat *n, const GLfloat *v);
typedef FNGLNORMAL3FVERTEX3FVSUNPROC *PFNGLNORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLCOLOR4FNORMAL3FVERTEX3FSUNPROC) (GLfloat r, GLfloat g, GLfloat b, GLfloat a, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLCOLOR4FNORMAL3FVERTEX3FSUNPROC *PFNGLCOLOR4FNORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLCOLOR4FNORMAL3FVERTEX3FVSUNPROC) (const GLfloat *c, const GLfloat *n, const GLfloat *v);
typedef FNGLCOLOR4FNORMAL3FVERTEX3FVSUNPROC *PFNGLCOLOR4FNORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FVERTEX3FSUNPROC) (GLfloat s, GLfloat t, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLTEXCOORD2FVERTEX3FSUNPROC *PFNGLTEXCOORD2FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FVERTEX3FVSUNPROC) (const GLfloat *tc, const GLfloat *v);
typedef FNGLTEXCOORD2FVERTEX3FVSUNPROC *PFNGLTEXCOORD2FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD4FVERTEX4FSUNPROC) (GLfloat s, GLfloat t, GLfloat p, GLfloat q, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLTEXCOORD4FVERTEX4FSUNPROC *PFNGLTEXCOORD4FVERTEX4FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD4FVERTEX4FVSUNPROC) (const GLfloat *tc, const GLfloat *v);
typedef FNGLTEXCOORD4FVERTEX4FVSUNPROC *PFNGLTEXCOORD4FVERTEX4FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FCOLOR4UBVERTEX3FSUNPROC) (GLfloat s, GLfloat t, GLubyte r, GLubyte g, GLubyte b, GLubyte a, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLTEXCOORD2FCOLOR4UBVERTEX3FSUNPROC *PFNGLTEXCOORD2FCOLOR4UBVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FCOLOR4UBVERTEX3FVSUNPROC) (const GLfloat *tc, const GLubyte *c, const GLfloat *v);
typedef FNGLTEXCOORD2FCOLOR4UBVERTEX3FVSUNPROC *PFNGLTEXCOORD2FCOLOR4UBVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FCOLOR3FVERTEX3FSUNPROC) (GLfloat s, GLfloat t, GLfloat r, GLfloat g, GLfloat b, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLTEXCOORD2FCOLOR3FVERTEX3FSUNPROC *PFNGLTEXCOORD2FCOLOR3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FCOLOR3FVERTEX3FVSUNPROC) (const GLfloat *tc, const GLfloat *c, const GLfloat *v);
typedef FNGLTEXCOORD2FCOLOR3FVERTEX3FVSUNPROC *PFNGLTEXCOORD2FCOLOR3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FNORMAL3FVERTEX3FSUNPROC) (GLfloat s, GLfloat t, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLTEXCOORD2FNORMAL3FVERTEX3FSUNPROC *PFNGLTEXCOORD2FNORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FNORMAL3FVERTEX3FVSUNPROC) (const GLfloat *tc, const GLfloat *n, const GLfloat *v);
typedef FNGLTEXCOORD2FNORMAL3FVERTEX3FVSUNPROC *PFNGLTEXCOORD2FNORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FCOLOR4FNORMAL3FVERTEX3FSUNPROC) (GLfloat s, GLfloat t, GLfloat r, GLfloat g, GLfloat b, GLfloat a, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLTEXCOORD2FCOLOR4FNORMAL3FVERTEX3FSUNPROC *PFNGLTEXCOORD2FCOLOR4FNORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD2FCOLOR4FNORMAL3FVERTEX3FVSUNPROC) (const GLfloat *tc, const GLfloat *c, const GLfloat *n, const GLfloat *v);
typedef FNGLTEXCOORD2FCOLOR4FNORMAL3FVERTEX3FVSUNPROC *PFNGLTEXCOORD2FCOLOR4FNORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD4FCOLOR4FNORMAL3FVERTEX4FSUNPROC) (GLfloat s, GLfloat t, GLfloat p, GLfloat q, GLfloat r, GLfloat g, GLfloat b, GLfloat a, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLTEXCOORD4FCOLOR4FNORMAL3FVERTEX4FSUNPROC *PFNGLTEXCOORD4FCOLOR4FNORMAL3FVERTEX4FSUNPROC;
typedef void (APIENTRY FNGLTEXCOORD4FCOLOR4FNORMAL3FVERTEX4FVSUNPROC) (const GLfloat *tc, const GLfloat *c, const GLfloat *n, const GLfloat *v);
typedef FNGLTEXCOORD4FCOLOR4FNORMAL3FVERTEX4FVSUNPROC *PFNGLTEXCOORD4FCOLOR4FNORMAL3FVERTEX4FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUIVERTEX3FSUNPROC) (GLuint rc, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUIVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUIVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUIVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUIVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUIVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUICOLOR4UBVERTEX3FSUNPROC) (GLuint rc, GLubyte r, GLubyte g, GLubyte b, GLubyte a, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUICOLOR4UBVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUICOLOR4UBVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUICOLOR4UBVERTEX3FVSUNPROC) (const GLuint *rc, const GLubyte *c, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUICOLOR4UBVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUICOLOR4UBVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUICOLOR3FVERTEX3FSUNPROC) (GLuint rc, GLfloat r, GLfloat g, GLfloat b, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUICOLOR3FVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUICOLOR3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUICOLOR3FVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *c, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUICOLOR3FVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUICOLOR3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUINORMAL3FVERTEX3FSUNPROC) (GLuint rc, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUINORMAL3FVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUINORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUINORMAL3FVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *n, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUINORMAL3FVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUINORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUICOLOR4FNORMAL3FVERTEX3FSUNPROC) (GLuint rc, GLfloat r, GLfloat g, GLfloat b, GLfloat a, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUICOLOR4FNORMAL3FVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUICOLOR4FNORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUICOLOR4FNORMAL3FVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *c, const GLfloat *n, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUICOLOR4FNORMAL3FVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUICOLOR4FNORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUITEXCOORD2FVERTEX3FSUNPROC) (GLuint rc, GLfloat s, GLfloat t, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUITEXCOORD2FVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUITEXCOORD2FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUITEXCOORD2FVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *tc, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUITEXCOORD2FVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUITEXCOORD2FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FSUNPROC) (GLuint rc, GLfloat s, GLfloat t, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FSUNPROC *PFNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *tc, const GLfloat *n, const GLfloat *v);
typedef FNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FVSUNPROC *PFNGLREPLACEMENTCODEUITEXCOORD2FNORMAL3FVERTEX3FVSUNPROC;
typedef void (APIENTRY FNGLREPLACEMENTCODEUITEXCOORD2FCOLOR4FNORMAL3FVERTEX3FSUNPROC) (GLuint rc, GLfloat s, GLfloat t, GLfloat r, GLfloat g, GLfloat b, GLfloat a, GLfloat nx, GLfloat ny, GLfloat nz, GLfloat x, GLfloat y, GLfloat z);
...
typedef void (APIENTRY FNGLREPLACEMENTCODEUITEXCOORD2FCOLOR4FNORMAL3FVERTEX3FVSUNPROC) (const GLuint *rc, const GLfloat *tc, const GLfloat *c, const GLfloat *n, const GLfloat *v);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLBLENDFUNCSEPARATEEXTPROC) (GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLBLENDFUNCSEPARATEINGRPROC) (GLenum sfactorRGB, GLenum dfactorRGB, GLenum sfactorAlpha, GLenum dfactorAlpha);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLVERTEXWEIGHTFEXTPROC) (GLfloat weight);
typedef FNGLVERTEXWEIGHTFEXTPROC *PFNGLVERTEXWEIGHTFEXTPROC;
typedef void (APIENTRY FNGLVERTEXWEIGHTFVEXTPROC) (const GLfloat *weight);
typedef FNGLVERTEXWEIGHTFVEXTPROC *PFNGLVERTEXWEIGHTFVEXTPROC;
typedef void (APIENTRY FNGLVERTEXWEIGHTPOINTEREXTPROC) (GLsizei size, GLenum type, GLsizei stride, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLFLUSHVERTEXARRAYRANGENVPROC) (void);
typedef FNGLFLUSHVERTEXARRAYRANGENVPROC *PFNGLFLUSHVERTEXARRAYRANGENVPROC;
typedef void (APIENTRY FNGLVERTEXARRAYRANGENVPROC) (GLsizei length, const GLvoid *pointer);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOMBINERPARAMETERFVNVPROC) (GLenum pname, const GLfloat *params);
typedef FNGLCOMBINERPARAMETERFVNVPROC *PFNGLCOMBINERPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLCOMBINERPARAMETERFNVPROC) (GLenum pname, GLfloat param);
typedef FNGLCOMBINERPARAMETERFNVPROC *PFNGLCOMBINERPARAMETERFNVPROC;
typedef void (APIENTRY FNGLCOMBINERPARAMETERIVNVPROC) (GLenum pname, const GLint *params);
typedef FNGLCOMBINERPARAMETERIVNVPROC *PFNGLCOMBINERPARAMETERIVNVPROC;
typedef void (APIENTRY FNGLCOMBINERPARAMETERINVPROC) (GLenum pname, GLint param);
typedef FNGLCOMBINERPARAMETERINVPROC *PFNGLCOMBINERPARAMETERINVPROC;
typedef void (APIENTRY FNGLCOMBINERINPUTNVPROC) (GLenum stage, GLenum portion, GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
typedef FNGLCOMBINERINPUTNVPROC *PFNGLCOMBINERINPUTNVPROC;
typedef void (APIENTRY FNGLCOMBINEROUTPUTNVPROC) (GLenum stage, GLenum portion, GLenum abOutput, GLenum cdOutput, GLenum sumOutput, GLenum scale, GLenum bias, GLboolean abDotProduct, GLboolean cdDotProduct, GLboolean muxSum);
typedef FNGLCOMBINEROUTPUTNVPROC *PFNGLCOMBINEROUTPUTNVPROC;
typedef void (APIENTRY FNGLFINALCOMBINERINPUTNVPROC) (GLenum variable, GLenum input, GLenum mapping, GLenum componentUsage);
typedef FNGLFINALCOMBINERINPUTNVPROC *PFNGLFINALCOMBINERINPUTNVPROC;
typedef void (APIENTRY FNGLGETCOMBINERINPUTPARAMETERFVNVPROC) (GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLfloat *params);
typedef FNGLGETCOMBINERINPUTPARAMETERFVNVPROC *PFNGLGETCOMBINERINPUTPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETCOMBINERINPUTPARAMETERIVNVPROC) (GLenum stage, GLenum portion, GLenum variable, GLenum pname, GLint *params);
typedef FNGLGETCOMBINERINPUTPARAMETERIVNVPROC *PFNGLGETCOMBINERINPUTPARAMETERIVNVPROC;
typedef void (APIENTRY FNGLGETCOMBINEROUTPUTPARAMETERFVNVPROC) (GLenum stage, GLenum portion, GLenum pname, GLfloat *params);
typedef FNGLGETCOMBINEROUTPUTPARAMETERFVNVPROC *PFNGLGETCOMBINEROUTPUTPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETCOMBINEROUTPUTPARAMETERIVNVPROC) (GLenum stage, GLenum portion, GLenum pname, GLint *params);
typedef FNGLGETCOMBINEROUTPUTPARAMETERIVNVPROC *PFNGLGETCOMBINEROUTPUTPARAMETERIVNVPROC;
typedef void (APIENTRY FNGLGETFINALCOMBINERINPUTPARAMETERFVNVPROC) (GLenum variable, GLenum pname, GLfloat *params);
typedef FNGLGETFINALCOMBINERINPUTPARAMETERFVNVPROC *PFNGLGETFINALCOMBINERINPUTPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETFINALCOMBINERINPUTPARAMETERIVNVPROC) (GLenum variable, GLenum pname, GLint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLRESIZEBUFFERSMESAPROC) (void);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLWINDOWPOS2DMESAPROC) (GLdouble x, GLdouble y);
typedef FNGLWINDOWPOS2DMESAPROC *PFNGLWINDOWPOS2DMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2DVMESAPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS2DVMESAPROC *PFNGLWINDOWPOS2DVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2FMESAPROC) (GLfloat x, GLfloat y);
typedef FNGLWINDOWPOS2FMESAPROC *PFNGLWINDOWPOS2FMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2FVMESAPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS2FVMESAPROC *PFNGLWINDOWPOS2FVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2IMESAPROC) (GLint x, GLint y);
typedef FNGLWINDOWPOS2IMESAPROC *PFNGLWINDOWPOS2IMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2IVMESAPROC) (const GLint *v);
typedef FNGLWINDOWPOS2IVMESAPROC *PFNGLWINDOWPOS2IVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2SMESAPROC) (GLshort x, GLshort y);
typedef FNGLWINDOWPOS2SMESAPROC *PFNGLWINDOWPOS2SMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS2SVMESAPROC) (const GLshort *v);
typedef FNGLWINDOWPOS2SVMESAPROC *PFNGLWINDOWPOS2SVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3DMESAPROC) (GLdouble x, GLdouble y, GLdouble z);
typedef FNGLWINDOWPOS3DMESAPROC *PFNGLWINDOWPOS3DMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3DVMESAPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS3DVMESAPROC *PFNGLWINDOWPOS3DVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3FMESAPROC) (GLfloat x, GLfloat y, GLfloat z);
typedef FNGLWINDOWPOS3FMESAPROC *PFNGLWINDOWPOS3FMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3FVMESAPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS3FVMESAPROC *PFNGLWINDOWPOS3FVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3IMESAPROC) (GLint x, GLint y, GLint z);
typedef FNGLWINDOWPOS3IMESAPROC *PFNGLWINDOWPOS3IMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3IVMESAPROC) (const GLint *v);
typedef FNGLWINDOWPOS3IVMESAPROC *PFNGLWINDOWPOS3IVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3SMESAPROC) (GLshort x, GLshort y, GLshort z);
typedef FNGLWINDOWPOS3SMESAPROC *PFNGLWINDOWPOS3SMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS3SVMESAPROC) (const GLshort *v);
typedef FNGLWINDOWPOS3SVMESAPROC *PFNGLWINDOWPOS3SVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4DMESAPROC) (GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLWINDOWPOS4DMESAPROC *PFNGLWINDOWPOS4DMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4DVMESAPROC) (const GLdouble *v);
typedef FNGLWINDOWPOS4DVMESAPROC *PFNGLWINDOWPOS4DVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4FMESAPROC) (GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLWINDOWPOS4FMESAPROC *PFNGLWINDOWPOS4FMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4FVMESAPROC) (const GLfloat *v);
typedef FNGLWINDOWPOS4FVMESAPROC *PFNGLWINDOWPOS4FVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4IMESAPROC) (GLint x, GLint y, GLint z, GLint w);
typedef FNGLWINDOWPOS4IMESAPROC *PFNGLWINDOWPOS4IMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4IVMESAPROC) (const GLint *v);
typedef FNGLWINDOWPOS4IVMESAPROC *PFNGLWINDOWPOS4IVMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4SMESAPROC) (GLshort x, GLshort y, GLshort z, GLshort w);
typedef FNGLWINDOWPOS4SMESAPROC *PFNGLWINDOWPOS4SMESAPROC;
typedef void (APIENTRY FNGLWINDOWPOS4SVMESAPROC) (const GLshort *v);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLMULTIMODEDRAWARRAYSIBMPROC) (GLenum mode, const GLint *first, const GLsizei *count, GLsizei primcount, GLint modestride);
typedef FNGLMULTIMODEDRAWARRAYSIBMPROC *PFNGLMULTIMODEDRAWARRAYSIBMPROC;
typedef void (APIENTRY FNGLMULTIMODEDRAWELEMENTSIBMPROC) (const GLenum *mode, const GLsizei *count, GLenum type, const GLvoid* *indices, GLsizei primcount, GLint modestride);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOLORPOINTERLISTIBMPROC) (GLint size, GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
typedef FNGLCOLORPOINTERLISTIBMPROC *PFNGLCOLORPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLSECONDARYCOLORPOINTERLISTIBMPROC) (GLint size, GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
typedef FNGLSECONDARYCOLORPOINTERLISTIBMPROC *PFNGLSECONDARYCOLORPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLEDGEFLAGPOINTERLISTIBMPROC) (GLint stride, const GLboolean* *pointer, GLint ptrstride);
typedef FNGLEDGEFLAGPOINTERLISTIBMPROC *PFNGLEDGEFLAGPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLFOGCOORDPOINTERLISTIBMPROC) (GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
typedef FNGLFOGCOORDPOINTERLISTIBMPROC *PFNGLFOGCOORDPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLINDEXPOINTERLISTIBMPROC) (GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
typedef FNGLINDEXPOINTERLISTIBMPROC *PFNGLINDEXPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLNORMALPOINTERLISTIBMPROC) (GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
typedef FNGLNORMALPOINTERLISTIBMPROC *PFNGLNORMALPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLTEXCOORDPOINTERLISTIBMPROC) (GLint size, GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
typedef FNGLTEXCOORDPOINTERLISTIBMPROC *PFNGLTEXCOORDPOINTERLISTIBMPROC;
typedef void (APIENTRY FNGLVERTEXPOINTERLISTIBMPROC) (GLint size, GLenum type, GLint stride, const GLvoid* *pointer, GLint ptrstride);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTBUFFERMASK3DFXPROC) (GLuint mask);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLSAMPLEMASKEXTPROC) (GLclampf value, GLboolean invert);
typedef FNGLSAMPLEMASKEXTPROC *PFNGLSAMPLEMASKEXTPROC;
typedef void (APIENTRY FNGLSAMPLEPATTERNEXTPROC) (GLenum pattern);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTEXTURECOLORMASKSGISPROC) (GLboolean red, GLboolean green, GLboolean blue, GLboolean alpha);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLIGLOOINTERFACESGIXPROC) (GLenum pname, const GLvoid *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLDELETEFENCESNVPROC) (GLsizei n, const GLuint *fences);
typedef FNGLDELETEFENCESNVPROC *PFNGLDELETEFENCESNVPROC;
typedef void (APIENTRY FNGLGENFENCESNVPROC) (GLsizei n, GLuint *fences);
typedef FNGLGENFENCESNVPROC *PFNGLGENFENCESNVPROC;
typedef GLboolean (APIENTRY FNGLISFENCENVPROC) (GLuint fence);
typedef FNGLISFENCENVPROC *PFNGLISFENCENVPROC;
typedef GLboolean (APIENTRY FNGLTESTFENCENVPROC) (GLuint fence);
typedef FNGLTESTFENCENVPROC *PFNGLTESTFENCENVPROC;
typedef void (APIENTRY FNGLGETFENCEIVNVPROC) (GLuint fence, GLenum pname, GLint *params);
typedef FNGLGETFENCEIVNVPROC *PFNGLGETFENCEIVNVPROC;
typedef void (APIENTRY FNGLFINISHFENCENVPROC) (GLuint fence);
typedef FNGLFINISHFENCENVPROC *PFNGLFINISHFENCENVPROC;
typedef void (APIENTRY FNGLSETFENCENVPROC) (GLuint fence, GLenum condition);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLMAPCONTROLPOINTSNVPROC) (GLenum target, GLuint index, GLenum type, GLsizei ustride, GLsizei vstride, GLint uorder, GLint vorder, GLboolean packed, const GLvoid *points);
typedef FNGLMAPCONTROLPOINTSNVPROC *PFNGLMAPCONTROLPOINTSNVPROC;
typedef void (APIENTRY FNGLMAPPARAMETERIVNVPROC) (GLenum target, GLenum pname, const GLint *params);
typedef FNGLMAPPARAMETERIVNVPROC *PFNGLMAPPARAMETERIVNVPROC;
typedef void (APIENTRY FNGLMAPPARAMETERFVNVPROC) (GLenum target, GLenum pname, const GLfloat *params);
typedef FNGLMAPPARAMETERFVNVPROC *PFNGLMAPPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETMAPCONTROLPOINTSNVPROC) (GLenum target, GLuint index, GLenum type, GLsizei ustride, GLsizei vstride, GLboolean packed, GLvoid *points);
typedef FNGLGETMAPCONTROLPOINTSNVPROC *PFNGLGETMAPCONTROLPOINTSNVPROC;
typedef void (APIENTRY FNGLGETMAPPARAMETERIVNVPROC) (GLenum target, GLenum pname, GLint *params);
typedef FNGLGETMAPPARAMETERIVNVPROC *PFNGLGETMAPPARAMETERIVNVPROC;
typedef void (APIENTRY FNGLGETMAPPARAMETERFVNVPROC) (GLenum target, GLenum pname, GLfloat *params);
typedef FNGLGETMAPPARAMETERFVNVPROC *PFNGLGETMAPPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETMAPATTRIBPARAMETERIVNVPROC) (GLenum target, GLuint index, GLenum pname, GLint *params);
typedef FNGLGETMAPATTRIBPARAMETERIVNVPROC *PFNGLGETMAPATTRIBPARAMETERIVNVPROC;
typedef void (APIENTRY FNGLGETMAPATTRIBPARAMETERFVNVPROC) (GLenum target, GLuint index, GLenum pname, GLfloat *params);
typedef FNGLGETMAPATTRIBPARAMETERFVNVPROC *PFNGLGETMAPATTRIBPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLEVALMAPSNVPROC) (GLenum target, GLenum mode);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLCOMBINERSTAGEPARAMETERFVNVPROC) (GLenum stage, GLenum pname, const GLfloat *params);
typedef FNGLCOMBINERSTAGEPARAMETERFVNVPROC *PFNGLCOMBINERSTAGEPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETCOMBINERSTAGEPARAMETERFVNVPROC) (GLenum stage, GLenum pname, GLfloat *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef GLboolean (APIENTRY FNGLAREPROGRAMSRESIDENTNVPROC) (GLsizei n, const GLuint *programs, GLboolean *residences);
typedef FNGLAREPROGRAMSRESIDENTNVPROC *PFNGLAREPROGRAMSRESIDENTNVPROC;
typedef void (APIENTRY FNGLBINDPROGRAMNVPROC) (GLenum target, GLuint id);
typedef FNGLBINDPROGRAMNVPROC *PFNGLBINDPROGRAMNVPROC;
typedef void (APIENTRY FNGLDELETEPROGRAMSNVPROC) (GLsizei n, const GLuint *programs);
typedef FNGLDELETEPROGRAMSNVPROC *PFNGLDELETEPROGRAMSNVPROC;
typedef void (APIENTRY FNGLEXECUTEPROGRAMNVPROC) (GLenum target, GLuint id, const GLfloat *params);
typedef FNGLEXECUTEPROGRAMNVPROC *PFNGLEXECUTEPROGRAMNVPROC;
typedef void (APIENTRY FNGLGENPROGRAMSNVPROC) (GLsizei n, GLuint *programs);
typedef FNGLGENPROGRAMSNVPROC *PFNGLGENPROGRAMSNVPROC;
typedef void (APIENTRY FNGLGETPROGRAMPARAMETERDVNVPROC) (GLenum target, GLuint index, GLenum pname, GLdouble *params);
typedef FNGLGETPROGRAMPARAMETERDVNVPROC *PFNGLGETPROGRAMPARAMETERDVNVPROC;
typedef void (APIENTRY FNGLGETPROGRAMPARAMETERFVNVPROC) (GLenum target, GLuint index, GLenum pname, GLfloat *params);
typedef FNGLGETPROGRAMPARAMETERFVNVPROC *PFNGLGETPROGRAMPARAMETERFVNVPROC;
typedef void (APIENTRY FNGLGETPROGRAMIVNVPROC) (GLuint id, GLenum pname, GLint *params);
typedef FNGLGETPROGRAMIVNVPROC *PFNGLGETPROGRAMIVNVPROC;
typedef void (APIENTRY FNGLGETPROGRAMSTRINGNVPROC) (GLuint id, GLenum pname, GLubyte *program);
typedef FNGLGETPROGRAMSTRINGNVPROC *PFNGLGETPROGRAMSTRINGNVPROC;
typedef void (APIENTRY FNGLGETTRACKMATRIXIVNVPROC) (GLenum target, GLuint address, GLenum pname, GLint *params);
typedef FNGLGETTRACKMATRIXIVNVPROC *PFNGLGETTRACKMATRIXIVNVPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBDVNVPROC) (GLuint index, GLenum pname, GLdouble *params);
typedef FNGLGETVERTEXATTRIBDVNVPROC *PFNGLGETVERTEXATTRIBDVNVPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBFVNVPROC) (GLuint index, GLenum pname, GLfloat *params);
typedef FNGLGETVERTEXATTRIBFVNVPROC *PFNGLGETVERTEXATTRIBFVNVPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBIVNVPROC) (GLuint index, GLenum pname, GLint *params);
typedef FNGLGETVERTEXATTRIBIVNVPROC *PFNGLGETVERTEXATTRIBIVNVPROC;
typedef void (APIENTRY FNGLGETVERTEXATTRIBPOINTERVNVPROC) (GLuint index, GLenum pname, GLvoid* *pointer);
typedef FNGLGETVERTEXATTRIBPOINTERVNVPROC *PFNGLGETVERTEXATTRIBPOINTERVNVPROC;
typedef GLboolean (APIENTRY FNGLISPROGRAMNVPROC) (GLuint id);
typedef FNGLISPROGRAMNVPROC *PFNGLISPROGRAMNVPROC;
typedef void (APIENTRY FNGLLOADPROGRAMNVPROC) (GLenum target, GLuint id, GLsizei len, const GLubyte *program);
typedef FNGLLOADPROGRAMNVPROC *PFNGLLOADPROGRAMNVPROC;
typedef void (APIENTRY FNGLPROGRAMPARAMETER4DNVPROC) (GLenum target, GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLPROGRAMPARAMETER4DNVPROC *PFNGLPROGRAMPARAMETER4DNVPROC;
typedef void (APIENTRY FNGLPROGRAMPARAMETER4DVNVPROC) (GLenum target, GLuint index, const GLdouble *v);
typedef FNGLPROGRAMPARAMETER4DVNVPROC *PFNGLPROGRAMPARAMETER4DVNVPROC;
typedef void (APIENTRY FNGLPROGRAMPARAMETER4FNVPROC) (GLenum target, GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLPROGRAMPARAMETER4FNVPROC *PFNGLPROGRAMPARAMETER4FNVPROC;
typedef void (APIENTRY FNGLPROGRAMPARAMETER4FVNVPROC) (GLenum target, GLuint index, const GLfloat *v);
typedef FNGLPROGRAMPARAMETER4FVNVPROC *PFNGLPROGRAMPARAMETER4FVNVPROC;
typedef void (APIENTRY FNGLPROGRAMPARAMETERS4DVNVPROC) (GLenum target, GLuint index, GLuint count, const GLdouble *v);
typedef FNGLPROGRAMPARAMETERS4DVNVPROC *PFNGLPROGRAMPARAMETERS4DVNVPROC;
typedef void (APIENTRY FNGLPROGRAMPARAMETERS4FVNVPROC) (GLenum target, GLuint index, GLuint count, const GLfloat *v);
typedef FNGLPROGRAMPARAMETERS4FVNVPROC *PFNGLPROGRAMPARAMETERS4FVNVPROC;
typedef void (APIENTRY FNGLREQUESTRESIDENTPROGRAMSNVPROC) (GLsizei n, const GLuint *programs);
typedef FNGLREQUESTRESIDENTPROGRAMSNVPROC *PFNGLREQUESTRESIDENTPROGRAMSNVPROC;
typedef void (APIENTRY FNGLTRACKMATRIXNVPROC) (GLenum target, GLuint address, GLenum matrix, GLenum transform);
typedef FNGLTRACKMATRIXNVPROC *PFNGLTRACKMATRIXNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBPOINTERNVPROC) (GLuint index, GLint fsize, GLenum type, GLsizei stride, const GLvoid *pointer);
typedef FNGLVERTEXATTRIBPOINTERNVPROC *PFNGLVERTEXATTRIBPOINTERNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1DNVPROC) (GLuint index, GLdouble x);
typedef FNGLVERTEXATTRIB1DNVPROC *PFNGLVERTEXATTRIB1DNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1DVNVPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB1DVNVPROC *PFNGLVERTEXATTRIB1DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1FNVPROC) (GLuint index, GLfloat x);
typedef FNGLVERTEXATTRIB1FNVPROC *PFNGLVERTEXATTRIB1FNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1FVNVPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB1FVNVPROC *PFNGLVERTEXATTRIB1FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1SNVPROC) (GLuint index, GLshort x);
typedef FNGLVERTEXATTRIB1SNVPROC *PFNGLVERTEXATTRIB1SNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB1SVNVPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB1SVNVPROC *PFNGLVERTEXATTRIB1SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2DNVPROC) (GLuint index, GLdouble x, GLdouble y);
typedef FNGLVERTEXATTRIB2DNVPROC *PFNGLVERTEXATTRIB2DNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2DVNVPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB2DVNVPROC *PFNGLVERTEXATTRIB2DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2FNVPROC) (GLuint index, GLfloat x, GLfloat y);
typedef FNGLVERTEXATTRIB2FNVPROC *PFNGLVERTEXATTRIB2FNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2FVNVPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB2FVNVPROC *PFNGLVERTEXATTRIB2FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2SNVPROC) (GLuint index, GLshort x, GLshort y);
typedef FNGLVERTEXATTRIB2SNVPROC *PFNGLVERTEXATTRIB2SNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB2SVNVPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB2SVNVPROC *PFNGLVERTEXATTRIB2SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3DNVPROC) (GLuint index, GLdouble x, GLdouble y, GLdouble z);
typedef FNGLVERTEXATTRIB3DNVPROC *PFNGLVERTEXATTRIB3DNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3DVNVPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB3DVNVPROC *PFNGLVERTEXATTRIB3DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3FNVPROC) (GLuint index, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLVERTEXATTRIB3FNVPROC *PFNGLVERTEXATTRIB3FNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3FVNVPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB3FVNVPROC *PFNGLVERTEXATTRIB3FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3SNVPROC) (GLuint index, GLshort x, GLshort y, GLshort z);
typedef FNGLVERTEXATTRIB3SNVPROC *PFNGLVERTEXATTRIB3SNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB3SVNVPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB3SVNVPROC *PFNGLVERTEXATTRIB3SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4DNVPROC) (GLuint index, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLVERTEXATTRIB4DNVPROC *PFNGLVERTEXATTRIB4DNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4DVNVPROC) (GLuint index, const GLdouble *v);
typedef FNGLVERTEXATTRIB4DVNVPROC *PFNGLVERTEXATTRIB4DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4FNVPROC) (GLuint index, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLVERTEXATTRIB4FNVPROC *PFNGLVERTEXATTRIB4FNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4FVNVPROC) (GLuint index, const GLfloat *v);
typedef FNGLVERTEXATTRIB4FVNVPROC *PFNGLVERTEXATTRIB4FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4SNVPROC) (GLuint index, GLshort x, GLshort y, GLshort z, GLshort w);
typedef FNGLVERTEXATTRIB4SNVPROC *PFNGLVERTEXATTRIB4SNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4SVNVPROC) (GLuint index, const GLshort *v);
typedef FNGLVERTEXATTRIB4SVNVPROC *PFNGLVERTEXATTRIB4SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4UBNVPROC) (GLuint index, GLubyte x, GLubyte y, GLubyte z, GLubyte w);
typedef FNGLVERTEXATTRIB4UBNVPROC *PFNGLVERTEXATTRIB4UBNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIB4UBVNVPROC) (GLuint index, const GLubyte *v);
typedef FNGLVERTEXATTRIB4UBVNVPROC *PFNGLVERTEXATTRIB4UBVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS1DVNVPROC) (GLuint index, GLsizei count, const GLdouble *v);
typedef FNGLVERTEXATTRIBS1DVNVPROC *PFNGLVERTEXATTRIBS1DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS1FVNVPROC) (GLuint index, GLsizei count, const GLfloat *v);
typedef FNGLVERTEXATTRIBS1FVNVPROC *PFNGLVERTEXATTRIBS1FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS1SVNVPROC) (GLuint index, GLsizei count, const GLshort *v);
typedef FNGLVERTEXATTRIBS1SVNVPROC *PFNGLVERTEXATTRIBS1SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS2DVNVPROC) (GLuint index, GLsizei count, const GLdouble *v);
typedef FNGLVERTEXATTRIBS2DVNVPROC *PFNGLVERTEXATTRIBS2DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS2FVNVPROC) (GLuint index, GLsizei count, const GLfloat *v);
typedef FNGLVERTEXATTRIBS2FVNVPROC *PFNGLVERTEXATTRIBS2FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS2SVNVPROC) (GLuint index, GLsizei count, const GLshort *v);
typedef FNGLVERTEXATTRIBS2SVNVPROC *PFNGLVERTEXATTRIBS2SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS3DVNVPROC) (GLuint index, GLsizei count, const GLdouble *v);
typedef FNGLVERTEXATTRIBS3DVNVPROC *PFNGLVERTEXATTRIBS3DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS3FVNVPROC) (GLuint index, GLsizei count, const GLfloat *v);
typedef FNGLVERTEXATTRIBS3FVNVPROC *PFNGLVERTEXATTRIBS3FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS3SVNVPROC) (GLuint index, GLsizei count, const GLshort *v);
typedef FNGLVERTEXATTRIBS3SVNVPROC *PFNGLVERTEXATTRIBS3SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS4DVNVPROC) (GLuint index, GLsizei count, const GLdouble *v);
typedef FNGLVERTEXATTRIBS4DVNVPROC *PFNGLVERTEXATTRIBS4DVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS4FVNVPROC) (GLuint index, GLsizei count, const GLfloat *v);
typedef FNGLVERTEXATTRIBS4FVNVPROC *PFNGLVERTEXATTRIBS4FVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS4SVNVPROC) (GLuint index, GLsizei count, const GLshort *v);
typedef FNGLVERTEXATTRIBS4SVNVPROC *PFNGLVERTEXATTRIBS4SVNVPROC;
typedef void (APIENTRY FNGLVERTEXATTRIBS4UBVNVPROC) (GLuint index, GLsizei count, const GLubyte *v);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLTEXBUMPPARAMETERIVATIPROC) (GLenum pname, const GLint *param);
typedef FNGLTEXBUMPPARAMETERIVATIPROC *PFNGLTEXBUMPPARAMETERIVATIPROC;
typedef void (APIENTRY FNGLTEXBUMPPARAMETERFVATIPROC) (GLenum pname, const GLfloat *param);
typedef FNGLTEXBUMPPARAMETERFVATIPROC *PFNGLTEXBUMPPARAMETERFVATIPROC;
typedef void (APIENTRY FNGLGETTEXBUMPPARAMETERIVATIPROC) (GLenum pname, GLint *param);
typedef FNGLGETTEXBUMPPARAMETERIVATIPROC *PFNGLGETTEXBUMPPARAMETERIVATIPROC;
typedef void (APIENTRY FNGLGETTEXBUMPPARAMETERFVATIPROC) (GLenum pname, GLfloat *param);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef GLuint (APIENTRY FNGLGENFRAGMENTSHADERSATIPROC) (GLuint range);
typedef FNGLGENFRAGMENTSHADERSATIPROC *PFNGLGENFRAGMENTSHADERSATIPROC;
typedef void (APIENTRY FNGLBINDFRAGMENTSHADERATIPROC) (GLuint id);
typedef FNGLBINDFRAGMENTSHADERATIPROC *PFNGLBINDFRAGMENTSHADERATIPROC;
typedef void (APIENTRY FNGLDELETEFRAGMENTSHADERATIPROC) (GLuint id);
typedef FNGLDELETEFRAGMENTSHADERATIPROC *PFNGLDELETEFRAGMENTSHADERATIPROC;
typedef void (APIENTRY FNGLBEGINFRAGMENTSHADERATIPROC) (void);
typedef FNGLBEGINFRAGMENTSHADERATIPROC *PFNGLBEGINFRAGMENTSHADERATIPROC;
typedef void (APIENTRY FNGLENDFRAGMENTSHADERATIPROC) (void);
typedef FNGLENDFRAGMENTSHADERATIPROC *PFNGLENDFRAGMENTSHADERATIPROC;
typedef void (APIENTRY FNGLPASSTEXCOORDATIPROC) (GLuint dst, GLuint coord, GLenum swizzle);
typedef FNGLPASSTEXCOORDATIPROC *PFNGLPASSTEXCOORDATIPROC;
typedef void (APIENTRY FNGLSAMPLEMAPATIPROC) (GLuint dst, GLuint interp, GLenum swizzle);
typedef FNGLSAMPLEMAPATIPROC *PFNGLSAMPLEMAPATIPROC;
typedef void (APIENTRY FNGLCOLORFRAGMENTOP1ATIPROC) (GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod);
typedef FNGLCOLORFRAGMENTOP1ATIPROC *PFNGLCOLORFRAGMENTOP1ATIPROC;
typedef void (APIENTRY FNGLCOLORFRAGMENTOP2ATIPROC) (GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod);
typedef FNGLCOLORFRAGMENTOP2ATIPROC *PFNGLCOLORFRAGMENTOP2ATIPROC;
typedef void (APIENTRY FNGLCOLORFRAGMENTOP3ATIPROC) (GLenum op, GLuint dst, GLuint dstMask, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3, GLuint arg3Rep, GLuint arg3Mod);
typedef FNGLCOLORFRAGMENTOP3ATIPROC *PFNGLCOLORFRAGMENTOP3ATIPROC;
typedef void (APIENTRY FNGLALPHAFRAGMENTOP1ATIPROC) (GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod);
typedef FNGLALPHAFRAGMENTOP1ATIPROC *PFNGLALPHAFRAGMENTOP1ATIPROC;
typedef void (APIENTRY FNGLALPHAFRAGMENTOP2ATIPROC) (GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod);
typedef FNGLALPHAFRAGMENTOP2ATIPROC *PFNGLALPHAFRAGMENTOP2ATIPROC;
typedef void (APIENTRY FNGLALPHAFRAGMENTOP3ATIPROC) (GLenum op, GLuint dst, GLuint dstMod, GLuint arg1, GLuint arg1Rep, GLuint arg1Mod, GLuint arg2, GLuint arg2Rep, GLuint arg2Mod, GLuint arg3, GLuint arg3Rep, GLuint arg3Mod);
typedef FNGLALPHAFRAGMENTOP3ATIPROC *PFNGLALPHAFRAGMENTOP3ATIPROC;
typedef void (APIENTRY FNGLSETFRAGMENTSHADERCONSTANTATIPROC) (GLuint dst, const GLfloat *value);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPNTRIANGLESIATIPROC) (GLenum pname, GLint param);
typedef FNGLPNTRIANGLESIATIPROC *PFNGLPNTRIANGLESIATIPROC;
typedef void (APIENTRY FNGLPNTRIANGLESFATIPROC) (GLenum pname, GLfloat param);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef GLuint (APIENTRY FNGLNEWOBJECTBUFFERATIPROC) (GLsizei size, const GLvoid *pointer, GLenum usage);
typedef FNGLNEWOBJECTBUFFERATIPROC *PFNGLNEWOBJECTBUFFERATIPROC;
typedef GLboolean (APIENTRY FNGLISOBJECTBUFFERATIPROC) (GLuint buffer);
typedef FNGLISOBJECTBUFFERATIPROC *PFNGLISOBJECTBUFFERATIPROC;
typedef void (APIENTRY FNGLUPDATEOBJECTBUFFERATIPROC) (GLuint buffer, GLuint offset, GLsizei size, const GLvoid *pointer, GLenum preserve);
typedef FNGLUPDATEOBJECTBUFFERATIPROC *PFNGLUPDATEOBJECTBUFFERATIPROC;
typedef void (APIENTRY FNGLGETOBJECTBUFFERFVATIPROC) (GLuint buffer, GLenum pname, GLfloat *params);
typedef FNGLGETOBJECTBUFFERFVATIPROC *PFNGLGETOBJECTBUFFERFVATIPROC;
typedef void (APIENTRY FNGLGETOBJECTBUFFERIVATIPROC) (GLuint buffer, GLenum pname, GLint *params);
typedef FNGLGETOBJECTBUFFERIVATIPROC *PFNGLGETOBJECTBUFFERIVATIPROC;
typedef void (APIENTRY FNGLDELETEOBJECTBUFFERATIPROC) (GLuint buffer);
typedef FNGLDELETEOBJECTBUFFERATIPROC *PFNGLDELETEOBJECTBUFFERATIPROC;
typedef void (APIENTRY FNGLARRAYOBJECTATIPROC) (GLenum array, GLint size, GLenum type, GLsizei stride, GLuint buffer, GLuint offset);
typedef FNGLARRAYOBJECTATIPROC *PFNGLARRAYOBJECTATIPROC;
typedef void (APIENTRY FNGLGETARRAYOBJECTFVATIPROC) (GLenum array, GLenum pname, GLfloat *params);
typedef FNGLGETARRAYOBJECTFVATIPROC *PFNGLGETARRAYOBJECTFVATIPROC;
typedef void (APIENTRY FNGLGETARRAYOBJECTIVATIPROC) (GLenum array, GLenum pname, GLint *params);
typedef FNGLGETARRAYOBJECTIVATIPROC *PFNGLGETARRAYOBJECTIVATIPROC;
typedef void (APIENTRY FNGLVARIANTARRAYOBJECTATIPROC) (GLuint id, GLenum type, GLsizei stride, GLuint buffer, GLuint offset);
typedef FNGLVARIANTARRAYOBJECTATIPROC *PFNGLVARIANTARRAYOBJECTATIPROC;
typedef void (APIENTRY FNGLGETVARIANTARRAYOBJECTFVATIPROC) (GLuint id, GLenum pname, GLfloat *params);
typedef FNGLGETVARIANTARRAYOBJECTFVATIPROC *PFNGLGETVARIANTARRAYOBJECTFVATIPROC;
typedef void (APIENTRY FNGLGETVARIANTARRAYOBJECTIVATIPROC) (GLuint id, GLenum pname, GLint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLBEGINVERTEXSHADEREXTPROC) (void);
typedef FNGLBEGINVERTEXSHADEREXTPROC *PFNGLBEGINVERTEXSHADEREXTPROC;
typedef void (APIENTRY FNGLENDVERTEXSHADEREXTPROC) (void);
typedef FNGLENDVERTEXSHADEREXTPROC *PFNGLENDVERTEXSHADEREXTPROC;
typedef void (APIENTRY FNGLBINDVERTEXSHADEREXTPROC) (GLuint id);
typedef FNGLBINDVERTEXSHADEREXTPROC *PFNGLBINDVERTEXSHADEREXTPROC;
typedef GLuint (APIENTRY FNGLGENVERTEXSHADERSEXTPROC) (GLuint range);
typedef FNGLGENVERTEXSHADERSEXTPROC *PFNGLGENVERTEXSHADERSEXTPROC;
typedef void (APIENTRY FNGLDELETEVERTEXSHADEREXTPROC) (GLuint id);
typedef FNGLDELETEVERTEXSHADEREXTPROC *PFNGLDELETEVERTEXSHADEREXTPROC;
typedef void (APIENTRY FNGLSHADEROP1EXTPROC) (GLenum op, GLuint res, GLuint arg1);
typedef FNGLSHADEROP1EXTPROC *PFNGLSHADEROP1EXTPROC;
typedef void (APIENTRY FNGLSHADEROP2EXTPROC) (GLenum op, GLuint res, GLuint arg1, GLuint arg2);
typedef FNGLSHADEROP2EXTPROC *PFNGLSHADEROP2EXTPROC;
typedef void (APIENTRY FNGLSHADEROP3EXTPROC) (GLenum op, GLuint res, GLuint arg1, GLuint arg2, GLuint arg3);
typedef FNGLSHADEROP3EXTPROC *PFNGLSHADEROP3EXTPROC;
typedef void (APIENTRY FNGLSWIZZLEEXTPROC) (GLuint res, GLuint in, GLenum outX, GLenum outY, GLenum outZ, GLenum outW);
typedef FNGLSWIZZLEEXTPROC *PFNGLSWIZZLEEXTPROC;
typedef void (APIENTRY FNGLWRITEMASKEXTPROC) (GLuint res, GLuint in, GLenum outX, GLenum outY, GLenum outZ, GLenum outW);
typedef FNGLWRITEMASKEXTPROC *PFNGLWRITEMASKEXTPROC;
typedef void (APIENTRY FNGLINSERTCOMPONENTEXTPROC) (GLuint res, GLuint src, GLuint num);
typedef FNGLINSERTCOMPONENTEXTPROC *PFNGLINSERTCOMPONENTEXTPROC;
typedef void (APIENTRY FNGLEXTRACTCOMPONENTEXTPROC) (GLuint res, GLuint src, GLuint num);
typedef FNGLEXTRACTCOMPONENTEXTPROC *PFNGLEXTRACTCOMPONENTEXTPROC;
typedef GLuint (APIENTRY FNGLGENSYMBOLSEXTPROC) (GLenum datatype, GLenum storagetype, GLenum range, GLuint components);
typedef FNGLGENSYMBOLSEXTPROC *PFNGLGENSYMBOLSEXTPROC;
typedef void (APIENTRY FNGLSETINVARIANTEXTPROC) (GLuint id, GLenum type, const void *addr);
typedef FNGLSETINVARIANTEXTPROC *PFNGLSETINVARIANTEXTPROC;
typedef void (APIENTRY FNGLSETLOCALCONSTANTEXTPROC) (GLuint id, GLenum type, const void *addr);
typedef FNGLSETLOCALCONSTANTEXTPROC *PFNGLSETLOCALCONSTANTEXTPROC;
typedef void (APIENTRY FNGLVARIANTBVEXTPROC) (GLuint id, const GLbyte *addr);
typedef FNGLVARIANTBVEXTPROC *PFNGLVARIANTBVEXTPROC;
typedef void (APIENTRY FNGLVARIANTSVEXTPROC) (GLuint id, const GLshort *addr);
typedef FNGLVARIANTSVEXTPROC *PFNGLVARIANTSVEXTPROC;
typedef void (APIENTRY FNGLVARIANTIVEXTPROC) (GLuint id, const GLint *addr);
typedef FNGLVARIANTIVEXTPROC *PFNGLVARIANTIVEXTPROC;
typedef void (APIENTRY FNGLVARIANTFVEXTPROC) (GLuint id, const GLfloat *addr);
typedef FNGLVARIANTFVEXTPROC *PFNGLVARIANTFVEXTPROC;
typedef void (APIENTRY FNGLVARIANTDVEXTPROC) (GLuint id, const GLdouble *addr);
typedef FNGLVARIANTDVEXTPROC *PFNGLVARIANTDVEXTPROC;
typedef void (APIENTRY FNGLVARIANTUBVEXTPROC) (GLuint id, const GLubyte *addr);
typedef FNGLVARIANTUBVEXTPROC *PFNGLVARIANTUBVEXTPROC;
typedef void (APIENTRY FNGLVARIANTUSVEXTPROC) (GLuint id, const GLushort *addr);
typedef FNGLVARIANTUSVEXTPROC *PFNGLVARIANTUSVEXTPROC;
typedef void (APIENTRY FNGLVARIANTUIVEXTPROC) (GLuint id, const GLuint *addr);
typedef FNGLVARIANTUIVEXTPROC *PFNGLVARIANTUIVEXTPROC;
typedef void (APIENTRY FNGLVARIANTPOINTEREXTPROC) (GLuint id, GLenum type, GLuint stride, const void *addr);
typedef FNGLVARIANTPOINTEREXTPROC *PFNGLVARIANTPOINTEREXTPROC;
typedef void (APIENTRY FNGLENABLEVARIANTCLIENTSTATEEXTPROC) (GLuint id);
typedef FNGLENABLEVARIANTCLIENTSTATEEXTPROC *PFNGLENABLEVARIANTCLIENTSTATEEXTPROC;
typedef void (APIENTRY FNGLDISABLEVARIANTCLIENTSTATEEXTPROC) (GLuint id);
typedef FNGLDISABLEVARIANTCLIENTSTATEEXTPROC *PFNGLDISABLEVARIANTCLIENTSTATEEXTPROC;
typedef GLuint (APIENTRY FNGLBINDLIGHTPARAMETEREXTPROC) (GLenum light, GLenum value);
typedef FNGLBINDLIGHTPARAMETEREXTPROC *PFNGLBINDLIGHTPARAMETEREXTPROC;
typedef GLuint (APIENTRY FNGLBINDMATERIALPARAMETEREXTPROC) (GLenum face, GLenum value);
typedef FNGLBINDMATERIALPARAMETEREXTPROC *PFNGLBINDMATERIALPARAMETEREXTPROC;
typedef GLuint (APIENTRY FNGLBINDTEXGENPARAMETEREXTPROC) (GLenum unit, GLenum coord, GLenum value);
typedef FNGLBINDTEXGENPARAMETEREXTPROC *PFNGLBINDTEXGENPARAMETEREXTPROC;
typedef GLuint (APIENTRY FNGLBINDTEXTUREUNITPARAMETEREXTPROC) (GLenum unit, GLenum value);
typedef FNGLBINDTEXTUREUNITPARAMETEREXTPROC *PFNGLBINDTEXTUREUNITPARAMETEREXTPROC;
typedef GLuint (APIENTRY FNGLBINDPARAMETEREXTPROC) (GLenum value);
typedef FNGLBINDPARAMETEREXTPROC *PFNGLBINDPARAMETEREXTPROC;
typedef GLboolean (APIENTRY FNGLISVARIANTENABLEDEXTPROC) (GLuint id, GLenum cap);
typedef FNGLISVARIANTENABLEDEXTPROC *PFNGLISVARIANTENABLEDEXTPROC;
typedef void (APIENTRY FNGLGETVARIANTBOOLEANVEXTPROC) (GLuint id, GLenum value, GLboolean *data);
typedef FNGLGETVARIANTBOOLEANVEXTPROC *PFNGLGETVARIANTBOOLEANVEXTPROC;
typedef void (APIENTRY FNGLGETVARIANTINTEGERVEXTPROC) (GLuint id, GLenum value, GLint *data);
typedef FNGLGETVARIANTINTEGERVEXTPROC *PFNGLGETVARIANTINTEGERVEXTPROC;
typedef void (APIENTRY FNGLGETVARIANTFLOATVEXTPROC) (GLuint id, GLenum value, GLfloat *data);
typedef FNGLGETVARIANTFLOATVEXTPROC *PFNGLGETVARIANTFLOATVEXTPROC;
typedef void (APIENTRY FNGLGETVARIANTPOINTERVEXTPROC) (GLuint id, GLenum value, GLvoid* *data);
typedef FNGLGETVARIANTPOINTERVEXTPROC *PFNGLGETVARIANTPOINTERVEXTPROC;
typedef void (APIENTRY FNGLGETINVARIANTBOOLEANVEXTPROC) (GLuint id, GLenum value, GLboolean *data);
typedef FNGLGETINVARIANTBOOLEANVEXTPROC *PFNGLGETINVARIANTBOOLEANVEXTPROC;
typedef void (APIENTRY FNGLGETINVARIANTINTEGERVEXTPROC) (GLuint id, GLenum value, GLint *data);
typedef FNGLGETINVARIANTINTEGERVEXTPROC *PFNGLGETINVARIANTINTEGERVEXTPROC;
typedef void (APIENTRY FNGLGETINVARIANTFLOATVEXTPROC) (GLuint id, GLenum value, GLfloat *data);
typedef FNGLGETINVARIANTFLOATVEXTPROC *PFNGLGETINVARIANTFLOATVEXTPROC;
typedef void (APIENTRY FNGLGETLOCALCONSTANTBOOLEANVEXTPROC) (GLuint id, GLenum value, GLboolean *data);
typedef FNGLGETLOCALCONSTANTBOOLEANVEXTPROC *PFNGLGETLOCALCONSTANTBOOLEANVEXTPROC;
typedef void (APIENTRY FNGLGETLOCALCONSTANTINTEGERVEXTPROC) (GLuint id, GLenum value, GLint *data);
typedef FNGLGETLOCALCONSTANTINTEGERVEXTPROC *PFNGLGETLOCALCONSTANTINTEGERVEXTPROC;
typedef void (APIENTRY FNGLGETLOCALCONSTANTFLOATVEXTPROC) (GLuint id, GLenum value, GLfloat *data);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLVERTEXSTREAM1SATIPROC) (GLenum stream, GLshort x);
typedef FNGLVERTEXSTREAM1SATIPROC *PFNGLVERTEXSTREAM1SATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1SVATIPROC) (GLenum stream, const GLshort *coords);
typedef FNGLVERTEXSTREAM1SVATIPROC *PFNGLVERTEXSTREAM1SVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1IATIPROC) (GLenum stream, GLint x);
typedef FNGLVERTEXSTREAM1IATIPROC *PFNGLVERTEXSTREAM1IATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1IVATIPROC) (GLenum stream, const GLint *coords);
typedef FNGLVERTEXSTREAM1IVATIPROC *PFNGLVERTEXSTREAM1IVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1FATIPROC) (GLenum stream, GLfloat x);
typedef FNGLVERTEXSTREAM1FATIPROC *PFNGLVERTEXSTREAM1FATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1FVATIPROC) (GLenum stream, const GLfloat *coords);
typedef FNGLVERTEXSTREAM1FVATIPROC *PFNGLVERTEXSTREAM1FVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1DATIPROC) (GLenum stream, GLdouble x);
typedef FNGLVERTEXSTREAM1DATIPROC *PFNGLVERTEXSTREAM1DATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM1DVATIPROC) (GLenum stream, const GLdouble *coords);
typedef FNGLVERTEXSTREAM1DVATIPROC *PFNGLVERTEXSTREAM1DVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2SATIPROC) (GLenum stream, GLshort x, GLshort y);
typedef FNGLVERTEXSTREAM2SATIPROC *PFNGLVERTEXSTREAM2SATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2SVATIPROC) (GLenum stream, const GLshort *coords);
typedef FNGLVERTEXSTREAM2SVATIPROC *PFNGLVERTEXSTREAM2SVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2IATIPROC) (GLenum stream, GLint x, GLint y);
typedef FNGLVERTEXSTREAM2IATIPROC *PFNGLVERTEXSTREAM2IATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2IVATIPROC) (GLenum stream, const GLint *coords);
typedef FNGLVERTEXSTREAM2IVATIPROC *PFNGLVERTEXSTREAM2IVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2FATIPROC) (GLenum stream, GLfloat x, GLfloat y);
typedef FNGLVERTEXSTREAM2FATIPROC *PFNGLVERTEXSTREAM2FATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2FVATIPROC) (GLenum stream, const GLfloat *coords);
typedef FNGLVERTEXSTREAM2FVATIPROC *PFNGLVERTEXSTREAM2FVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2DATIPROC) (GLenum stream, GLdouble x, GLdouble y);
typedef FNGLVERTEXSTREAM2DATIPROC *PFNGLVERTEXSTREAM2DATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM2DVATIPROC) (GLenum stream, const GLdouble *coords);
typedef FNGLVERTEXSTREAM2DVATIPROC *PFNGLVERTEXSTREAM2DVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3SATIPROC) (GLenum stream, GLshort x, GLshort y, GLshort z);
typedef FNGLVERTEXSTREAM3SATIPROC *PFNGLVERTEXSTREAM3SATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3SVATIPROC) (GLenum stream, const GLshort *coords);
typedef FNGLVERTEXSTREAM3SVATIPROC *PFNGLVERTEXSTREAM3SVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3IATIPROC) (GLenum stream, GLint x, GLint y, GLint z);
typedef FNGLVERTEXSTREAM3IATIPROC *PFNGLVERTEXSTREAM3IATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3IVATIPROC) (GLenum stream, const GLint *coords);
typedef FNGLVERTEXSTREAM3IVATIPROC *PFNGLVERTEXSTREAM3IVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3FATIPROC) (GLenum stream, GLfloat x, GLfloat y, GLfloat z);
typedef FNGLVERTEXSTREAM3FATIPROC *PFNGLVERTEXSTREAM3FATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3FVATIPROC) (GLenum stream, const GLfloat *coords);
typedef FNGLVERTEXSTREAM3FVATIPROC *PFNGLVERTEXSTREAM3FVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3DATIPROC) (GLenum stream, GLdouble x, GLdouble y, GLdouble z);
typedef FNGLVERTEXSTREAM3DATIPROC *PFNGLVERTEXSTREAM3DATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM3DVATIPROC) (GLenum stream, const GLdouble *coords);
typedef FNGLVERTEXSTREAM3DVATIPROC *PFNGLVERTEXSTREAM3DVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4SATIPROC) (GLenum stream, GLshort x, GLshort y, GLshort z, GLshort w);
typedef FNGLVERTEXSTREAM4SATIPROC *PFNGLVERTEXSTREAM4SATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4SVATIPROC) (GLenum stream, const GLshort *coords);
typedef FNGLVERTEXSTREAM4SVATIPROC *PFNGLVERTEXSTREAM4SVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4IATIPROC) (GLenum stream, GLint x, GLint y, GLint z, GLint w);
typedef FNGLVERTEXSTREAM4IATIPROC *PFNGLVERTEXSTREAM4IATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4IVATIPROC) (GLenum stream, const GLint *coords);
typedef FNGLVERTEXSTREAM4IVATIPROC *PFNGLVERTEXSTREAM4IVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4FATIPROC) (GLenum stream, GLfloat x, GLfloat y, GLfloat z, GLfloat w);
typedef FNGLVERTEXSTREAM4FATIPROC *PFNGLVERTEXSTREAM4FATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4FVATIPROC) (GLenum stream, const GLfloat *coords);
typedef FNGLVERTEXSTREAM4FVATIPROC *PFNGLVERTEXSTREAM4FVATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4DATIPROC) (GLenum stream, GLdouble x, GLdouble y, GLdouble z, GLdouble w);
typedef FNGLVERTEXSTREAM4DATIPROC *PFNGLVERTEXSTREAM4DATIPROC;
typedef void (APIENTRY FNGLVERTEXSTREAM4DVATIPROC) (GLenum stream, const GLdouble *coords);
typedef FNGLVERTEXSTREAM4DVATIPROC *PFNGLVERTEXSTREAM4DVATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3BATIPROC) (GLenum stream, GLbyte nx, GLbyte ny, GLbyte nz);
typedef FNGLNORMALSTREAM3BATIPROC *PFNGLNORMALSTREAM3BATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3BVATIPROC) (GLenum stream, const GLbyte *coords);
typedef FNGLNORMALSTREAM3BVATIPROC *PFNGLNORMALSTREAM3BVATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3SATIPROC) (GLenum stream, GLshort nx, GLshort ny, GLshort nz);
typedef FNGLNORMALSTREAM3SATIPROC *PFNGLNORMALSTREAM3SATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3SVATIPROC) (GLenum stream, const GLshort *coords);
typedef FNGLNORMALSTREAM3SVATIPROC *PFNGLNORMALSTREAM3SVATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3IATIPROC) (GLenum stream, GLint nx, GLint ny, GLint nz);
typedef FNGLNORMALSTREAM3IATIPROC *PFNGLNORMALSTREAM3IATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3IVATIPROC) (GLenum stream, const GLint *coords);
typedef FNGLNORMALSTREAM3IVATIPROC *PFNGLNORMALSTREAM3IVATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3FATIPROC) (GLenum stream, GLfloat nx, GLfloat ny, GLfloat nz);
typedef FNGLNORMALSTREAM3FATIPROC *PFNGLNORMALSTREAM3FATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3FVATIPROC) (GLenum stream, const GLfloat *coords);
typedef FNGLNORMALSTREAM3FVATIPROC *PFNGLNORMALSTREAM3FVATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3DATIPROC) (GLenum stream, GLdouble nx, GLdouble ny, GLdouble nz);
typedef FNGLNORMALSTREAM3DATIPROC *PFNGLNORMALSTREAM3DATIPROC;
typedef void (APIENTRY FNGLNORMALSTREAM3DVATIPROC) (GLenum stream, const GLdouble *coords);
typedef FNGLNORMALSTREAM3DVATIPROC *PFNGLNORMALSTREAM3DVATIPROC;
typedef void (APIENTRY FNGLCLIENTACTIVEVERTEXSTREAMATIPROC) (GLenum stream);
typedef FNGLCLIENTACTIVEVERTEXSTREAMATIPROC *PFNGLCLIENTACTIVEVERTEXSTREAMATIPROC;
typedef void (APIENTRY FNGLVERTEXBLENDENVIATIPROC) (GLenum pname, GLint param);
typedef FNGLVERTEXBLENDENVIATIPROC *PFNGLVERTEXBLENDENVIATIPROC;
typedef void (APIENTRY FNGLVERTEXBLENDENVFATIPROC) (GLenum pname, GLfloat param);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLELEMENTPOINTERATIPROC) (GLenum type, const GLvoid *pointer);
typedef FNGLELEMENTPOINTERATIPROC *PFNGLELEMENTPOINTERATIPROC;
typedef void (APIENTRY FNGLDRAWELEMENTARRAYATIPROC) (GLenum mode, GLsizei count);
typedef FNGLDRAWELEMENTARRAYATIPROC *PFNGLDRAWELEMENTARRAYATIPROC;
typedef void (APIENTRY FNGLDRAWRANGEELEMENTARRAYATIPROC) (GLenum mode, GLuint start, GLuint end, GLsizei count);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLDRAWMESHARRAYSSUNPROC) (GLenum mode, GLint first, GLsizei count, GLsizei width);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLGENOCCLUSIONQUERIESNVPROC) (GLsizei n, GLuint *ids);
typedef FNGLGENOCCLUSIONQUERIESNVPROC *PFNGLGENOCCLUSIONQUERIESNVPROC;
typedef void (APIENTRY FNGLDELETEOCCLUSIONQUERIESNVPROC) (GLsizei n, const GLuint *ids);
typedef FNGLDELETEOCCLUSIONQUERIESNVPROC *PFNGLDELETEOCCLUSIONQUERIESNVPROC;
typedef GLboolean (APIENTRY FNGLISOCCLUSIONQUERYNVPROC) (GLuint id);
typedef FNGLISOCCLUSIONQUERYNVPROC *PFNGLISOCCLUSIONQUERYNVPROC;
typedef void (APIENTRY FNGLBEGINOCCLUSIONQUERYNVPROC) (GLuint id);
typedef FNGLBEGINOCCLUSIONQUERYNVPROC *PFNGLBEGINOCCLUSIONQUERYNVPROC;
typedef void (APIENTRY FNGLENDOCCLUSIONQUERYNVPROC) (void);
typedef FNGLENDOCCLUSIONQUERYNVPROC *PFNGLENDOCCLUSIONQUERYNVPROC;
typedef void (APIENTRY FNGLGETOCCLUSIONQUERYIVNVPROC) (GLuint id, GLenum pname, GLint *params);
typedef FNGLGETOCCLUSIONQUERYIVNVPROC *PFNGLGETOCCLUSIONQUERYIVNVPROC;
typedef void (APIENTRY FNGLGETOCCLUSIONQUERYUIVNVPROC) (GLuint id, GLenum pname, GLuint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLPOINTPARAMETERINVPROC) (GLenum pname, GLint param);
typedef FNGLPOINTPARAMETERINVPROC *PFNGLPOINTPARAMETERINVPROC;
typedef void (APIENTRY FNGLPOINTPARAMETERIVNVPROC) (GLenum pname, const GLint *params);
...
#endif /* GL_GLEXT_PROTOTYPES */
typedef void (APIENTRY FNGLACTIVESTENCILFACEEXTPROC) (GLenum face);
